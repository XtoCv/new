...
msg_user_send_id = msg.sender.user_id
...
if Redis:sismember(TheMero.."medalid",msg.sender.user_id) then
local medaa2 = Redis:get(TheMero.."medal2"..msg.sender.user_id)
if medaa2 == "🥇" then
local medaa = Redis:get(TheMero.."medal"..msg.sender.user_id)
local medaa2 = Redis:get(TheMero.."medal2"..msg.sender.user_id)
local medaa3 = Redis:get(TheMero.."medal3"..msg.sender.user_id)
...
if text == Redis:get(TheMero..'klmahzr'..msg.chat_id) and msg.sender.user_id == Redis:get(TheMero..'playerhzr'..msg.chat_id) then
if not Redis:get(TheMero.."playerhzrktm"..msg.chat_id..msg.sender.user_id) then
...
if tonumber(playerhzr) == msg.sender.user_id then
if text == klmahzr then
Redis:del(TheMero.."Start_egabahzr"..msg.chat_id)
Redis:del(TheMero.."playerhzrktm"..msg.chat_id..msg.sender.user_id)
Redis:srem(TheMero.."Mero:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
cobnum = tonumber(Redis:get(TheMero.."bandid"..msg.sender.user_id))
if cobnum == msg.sender.user_id then
return send(msg.chat_id,msg.id, "⇜ حسابك محظور من لعبة البنك","md",true)
end
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
...
Redis:srem(TheMero.."booob", msg.sender.user_id)
Redis:srem(TheMero.."taza", msg.sender.user_id)
Redis:del(TheMero.."boob"..msg.sender.user_id)
Redis:del(TheMero.."boobb"..msg.sender.user_id)
Redis:del(TheMero.."rrfff"..msg.sender.user_id)
Redis:srem(TheMero.."rrfffid", msg.sender.user_id)
Redis:srem(TheMero.."roogg1", msg.sender.user_id)
Redis:srem(TheMero.."roogga1", msg.sender.user_id)
Redis:del(TheMero.."roog1"..msg.sender.user_id)
Redis:del(TheMero.."rooga1"..msg.sender.user_id)
Redis:del(TheMero.."rahr1"..msg.sender.user_id)
Redis:del(TheMero.."rahrr1"..msg.sender.user_id)
Redis:del(TheMero.."tabbroat"..msg.sender.user_id)
Redis:del(TheMero.."shkse"..msg.sender.user_id)
Redis:del(TheMero.."doltebank"..msg.sender.user_id)
Redis:del(TheMero.."ratbinc"..msg.sender.user_id)
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:del(TheMero.."mgrmasname"..msg.sender.user_id)
Redis:del(TheMero.."mgrmasnum"..msg.sender.user_id)
Redis:del(TheMero.."mgrkldname"..msg.sender.user_id)
Redis:del(TheMero.."mgrkldnum"..msg.sender.user_id)
Redis:del(TheMero.."mgrswrname"..msg.sender.user_id)
Redis:del(TheMero.."mgrswrnum"..msg.sender.user_id)
Redis:del(TheMero.."mgrktmname"..msg.sender.user_id)
Redis:del(TheMero.."mgrktmnum"..msg.sender.user_id)
Redis:del(TheMero.."akrksrname"..msg.sender.user_id)
Redis:del(TheMero.."akrksrnum"..msg.sender.user_id)
Redis:del(TheMero.."akrfelname"..msg.sender.user_id)
Redis:del(TheMero.."akrfelnum"..msg.sender.user_id)
Redis:del(TheMero.."akrmnzname"..msg.sender.user_id)
Redis:del(TheMero.."akrmnznum"..msg.sender.user_id)
Redis:del(TheMero.."airshbhname"..msg.sender.user_id)
Redis:del(TheMero.."airshbhnum"..msg.sender.user_id)
Redis:del(TheMero.."airsfarname"..msg.sender.user_id)
Redis:del(TheMero.."airsfarnum"..msg.sender.user_id)
Redis:del(TheMero.."airkhasname"..msg.sender.user_id)
Redis:del(TheMero.."airkhasnum"..msg.sender.user_id)
Redis:del(TheMero.."carrangname"..msg.sender.user_id)
Redis:del(TheMero.."carrangnum"..msg.sender.user_id)
Redis:del(TheMero.."caraccename"..msg.sender.user_id)
Redis:del(TheMero.."caraccenum"..msg.sender.user_id)
Redis:del(TheMero.."carcamrname"..msg.sender.user_id)
Redis:del(TheMero.."carcamrnum"..msg.sender.user_id)
Redis:del(TheMero.."caralntrname"..msg.sender.user_id)
Redis:del(TheMero.."caralntrnum"..msg.sender.user_id)
Redis:del(TheMero.."carhilxname"..msg.sender.user_id)
Redis:del(TheMero.."carhilxnum"..msg.sender.user_id)
Redis:del(TheMero.."carsonaname"..msg.sender.user_id)
Redis:del(TheMero.."carsonanum"..msg.sender.user_id)
Redis:del(TheMero.."carcoroname"..msg.sender.user_id)
Redis:del(TheMero.."carcoronum"..msg.sender.user_id)
namfra = Redis:get(TheMero.."namefram"..msg.sender.user_id)
Redis:del(TheMero.."toplvfarm"..msg.sender.user_id)
Redis:del(TheMero.."btatatime"..msg.sender.user_id)
Redis:del(TheMero.."btatanum"..msg.sender.user_id)
Redis:del(TheMero.."btataname"..msg.sender.user_id)
Redis:del(TheMero.."lemontime"..msg.sender.user_id)
Redis:del(TheMero.."lemonnum"..msg.sender.user_id)
Redis:del(TheMero.."lemonname"..msg.sender.user_id)
Redis:del(TheMero.."khesstime"..msg.sender.user_id)
Redis:del(TheMero.."khessnum"..msg.sender.user_id)
Redis:del(TheMero.."khessname"..msg.sender.user_id)
Redis:del(TheMero.."kheartime"..msg.sender.user_id)
Redis:del(TheMero.."khearnum"..msg.sender.user_id)
Redis:del(TheMero.."khearname"..msg.sender.user_id)
Redis:del(TheMero.."jzartime"..msg.sender.user_id)
Redis:del(TheMero.."jzarnum"..msg.sender.user_id)
Redis:del(TheMero.."jzarname"..msg.sender.user_id)
Redis:del(TheMero.."fleflatime"..msg.sender.user_id)
Redis:del(TheMero.."fleflanum"..msg.sender.user_id)
Redis:del(TheMero.."fleflaname"..msg.sender.user_id)
Redis:del(TheMero.."freaztime"..msg.sender.user_id)
Redis:del(TheMero.."freaznum"..msg.sender.user_id)
Redis:del(TheMero.."freazname"..msg.sender.user_id)
Redis:del(TheMero.."doratime"..msg.sender.user_id)
Redis:del(TheMero.."doranum"..msg.sender.user_id)
Redis:del(TheMero.."doraname"..msg.sender.user_id)
Redis:del(TheMero.."tomtime"..msg.sender.user_id)
Redis:del(TheMero.."tomnum"..msg.sender.user_id)
Redis:del(TheMero.."tomname"..msg.sender.user_id)
Redis:del(TheMero.."ftrtime"..msg.sender.user_id)
Redis:del(TheMero.."ftrnum"..msg.sender.user_id)
Redis:del(TheMero.."ftrname"..msg.sender.user_id)
Redis:del(TheMero.."tfahtime"..msg.sender.user_id)
Redis:del(TheMero.."tfahnum"..msg.sender.user_id)
Redis:del(TheMero.."tfahname"..msg.sender.user_id)
Redis:del(TheMero.."enabtime"..msg.sender.user_id)
Redis:del(TheMero.."enabnum"..msg.sender.user_id)
Redis:del(TheMero.."enabname"..msg.sender.user_id)
Redis:del(TheMero.."zetontime"..msg.sender.user_id)
Redis:del(TheMero.."zetonnum"..msg.sender.user_id)
Redis:del(TheMero.."zetonname"..msg.sender.user_id)
Redis:del(TheMero.."mozztime"..msg.sender.user_id)
Redis:del(TheMero.."mozznum"..msg.sender.user_id)
Redis:del(TheMero.."mozzname"..msg.sender.user_id)
Redis:del(TheMero.."mangatime"..msg.sender.user_id)
Redis:del(TheMero.."manganum"..msg.sender.user_id)
Redis:del(TheMero.."manganame"..msg.sender.user_id)
Redis:del(TheMero.."sizefram"..msg.sender.user_id)
Redis:del(TheMero.."namefram"..msg.sender.user_id)
Redis:del(TheMero.."mzroatsize"..msg.sender.user_id)
Redis:srem(TheMero.."farmarname", namfra)
Redis:srem(TheMero.."ownerfram",msg.sender.user_id)
namenad = Redis:get(TheMero.."lkbnade"..msg.sender.user_id)
Redis:del(TheMero.."namenade"..msg.sender.user_id)
Redis:del(TheMero.."nokatnade"..msg.sender.user_id)
Redis:del(TheMero.."energynade"..msg.sender.user_id)
Redis:del(TheMero.."traningnade"..msg.sender.user_id)
Redis:del(TheMero.."nameplayer".."1"..msg.sender.user_id)
Redis:del(TheMero.."nameplayer".."2"..msg.sender.user_id)
Redis:del(TheMero.."nameplayer".."3"..msg.sender.user_id)
Redis:del(TheMero.."nameplayer".."4"..msg.sender.user_id)
Redis:del(TheMero.."nameplayer".."5"..msg.sender.user_id)
Redis:del(TheMero.."energyplayer".."1"..msg.sender.user_id)
Redis:del(TheMero.."energyplayer".."2"..msg.sender.user_id)
Redis:del(TheMero.."energyplayer".."3"..msg.sender.user_id)
Redis:del(TheMero.."energyplayer".."4"..msg.sender.user_id)
Redis:del(TheMero.."energyplayer".."5"..msg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."1"..msg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."2"..msg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."3"..msg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."4"..msg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."5"..msg.sender.user_id)
Redis:del(TheMero.."cityplayer".."1"..msg.sender.user_id)
Redis:del(TheMero.."cityplayer".."2"..msg.sender.user_id)
Redis:del(TheMero.."cityplayer".."3"..msg.sender.user_id)
Redis:del(TheMero.."cityplayer".."4"..msg.sender.user_id)
Redis:del(TheMero.."cityplayer".."5"..msg.sender.user_id)
Redis:del(TheMero.."priceplayer".."1"..msg.sender.user_id)
Redis:del(TheMero.."priceplayer".."2"..msg.sender.user_id)
Redis:del(TheMero.."priceplayer".."3"..msg.sender.user_id)
Redis:del(TheMero.."priceplayer".."4"..msg.sender.user_id)
Redis:del(TheMero.."priceplayer".."5"..msg.sender.user_id)
Redis:srem(TheMero.."lkbnadesadd", namenad)
Redis:srem(TheMero.."ownernade",msg.sender.user_id)
Redis:del(TheMero.."lkbnade"..msg.sender.user_id)
else
...
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
ballancee = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
...
if Redis:sismember(TheMero.."booob",Remsg.sender.user_id) then
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
send(msg.chat_id,msg.id, "⇜ فلوسه `"..convert_mony.."` ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي ","md",true)
...
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
cccc = Redis:get(TheMero.."boobb"..msg.sender.user_id)
uuuu = Redis:get(TheMero.."bbobb"..msg.sender.user_id)
pppp = Redis:get(TheMero.."rrfff"..msg.sender.user_id) or 0
ballancee = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
shkse = Redis:get(TheMero.."shkse"..msg.sender.user_id)
doltebank = Redis:get(TheMero.."doltebank"..msg.sender.user_id)
local convert_mony = string.format("%.0f",ballancee)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(TheMero.."booob",Remsg.sender.user_id) then
local Cname = Redis:get(TheMero.."in_company:name:"..msg.sender.user_id) or 0
Redis:srem(TheMero.."company:mem:"..Cname, msg.sender.user_id)
Redis:srem(TheMero.."in_company:", msg.sender.user_id)
Redis:del(TheMero.."in_company:name:"..msg.sender.user_id, Cname)
ccccc = Redis:get(TheMero.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(TheMero.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(TheMero.."rrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
Redis:srem(TheMero.."booob", Remsg.sender.user_id)
Redis:srem(TheMero.."taza", Remsg.sender.user_id)
namfra = Redis:get(TheMero.."namefram"..Remsg.sender.user_id)
Redis:del(TheMero.."boob"..Remsg.sender.user_id)
Redis:del(TheMero.."boobb"..Remsg.sender.user_id)
Redis:del(TheMero.."rrfff"..Remsg.sender.user_id)
Redis:del(TheMero.."numattack"..Remsg.sender.user_id)
Redis:srem(TheMero.."rrfffid", Remsg.sender.user_id)
Redis:srem(TheMero.."roogg1", Remsg.sender.user_id)
Redis:srem(TheMero.."roogga1", Remsg.sender.user_id)
Redis:del(TheMero.."roog1"..Remsg.sender.user_id)
Redis:del(TheMero.."rooga1"..Remsg.sender.user_id)
Redis:del(TheMero.."rahr1"..Remsg.sender.user_id)
Redis:del(TheMero.."rahrr1"..Remsg.sender.user_id)
Redis:del(TheMero.."tabbroat"..Remsg.sender.user_id)
Redis:del(TheMero.."shkse"..Remsg.sender.user_id)
Redis:del(TheMero.."doltebank"..Remsg.sender.user_id)
Redis:del(TheMero.."ratbinc"..Remsg.sender.user_id)
Redis:del(TheMero.."ratbtrans"..Remsg.sender.user_id)
Redis:del(TheMero.."mgrmasname"..Remsg.sender.user_id)
Redis:del(TheMero.."mgrmasnum"..Remsg.sender.user_id)
Redis:del(TheMero.."mgrkldname"..Remsg.sender.user_id)
Redis:del(TheMero.."mgrkldnum"..Remsg.sender.user_id)
Redis:del(TheMero.."mgrswrname"..Remsg.sender.user_id)
Redis:del(TheMero.."mgrswrnum"..Remsg.sender.user_id)
Redis:del(TheMero.."mgrktmname"..Remsg.sender.user_id)
Redis:del(TheMero.."mgrktmnum"..Remsg.sender.user_id)
Redis:del(TheMero.."akrksrname"..Remsg.sender.user_id)
Redis:del(TheMero.."akrksrnum"..Remsg.sender.user_id)
Redis:del(TheMero.."akrfelname"..Remsg.sender.user_id)
Redis:del(TheMero.."akrfelnum"..Remsg.sender.user_id)
Redis:del(TheMero.."akrmnzname"..Remsg.sender.user_id)
Redis:del(TheMero.."akrmnznum"..Remsg.sender.user_id)
Redis:del(TheMero.."airshbhname"..Remsg.sender.user_id)
Redis:del(TheMero.."airshbhnum"..Remsg.sender.user_id)
Redis:del(TheMero.."airsfarname"..Remsg.sender.user_id)
Redis:del(TheMero.."airsfarnum"..Remsg.sender.user_id)
Redis:del(TheMero.."airkhasname"..Remsg.sender.user_id)
Redis:del(TheMero.."airkhasnum"..Remsg.sender.user_id)
Redis:del(TheMero.."carrangname"..Remsg.sender.user_id)
Redis:del(TheMero.."carrangnum"..Remsg.sender.user_id)
Redis:del(TheMero.."caraccename"..Remsg.sender.user_id)
Redis:del(TheMero.."caraccenum"..Remsg.sender.user_id)
Redis:del(TheMero.."carcamrname"..Remsg.sender.user_id)
Redis:del(TheMero.."carcamrnum"..Remsg.sender.user_id)
Redis:del(TheMero.."caralntrname"..Remsg.sender.user_id)
Redis:del(TheMero.."caralntrnum"..Remsg.sender.user_id)
Redis:del(TheMero.."carhilxname"..Remsg.sender.user_id)
Redis:del(TheMero.."carhilxnum"..Remsg.sender.user_id)
Redis:del(TheMero.."carsonaname"..Remsg.sender.user_id)
Redis:del(TheMero.."carsonanum"..Remsg.sender.user_id)
Redis:del(TheMero.."carcoroname"..Remsg.sender.user_id)
Redis:del(TheMero.."carcoronum"..Remsg.sender.user_id)
Redis:del(TheMero.."rotpa"..Remsg.sender.user_id)
Redis:del(TheMero.."rddd"..Remsg.sender.user_id)
Redis:del(TheMero.."rotpagrid"..Remsg.sender.user_id)
Redis:del(TheMero.."rotpaid"..Remsg.sender.user_id)
Redis:del(TheMero.."rdddgr"..Remsg.sender.user_id)
Redis:del(TheMero.."rdddid"..Remsg.sender.user_id)
Redis:del(TheMero.."rdddtex"..Remsg.sender.user_id)
Redis:del(TheMero.."toplvfarm"..Remsg.sender.user_id)
Redis:del(TheMero.."btatatime"..Remsg.sender.user_id)
Redis:del(TheMero.."btatanum"..Remsg.sender.user_id)
Redis:del(TheMero.."btataname"..Remsg.sender.user_id)
Redis:del(TheMero.."lemontime"..Remsg.sender.user_id)
Redis:del(TheMero.."lemonnum"..Remsg.sender.user_id)
Redis:del(TheMero.."lemonname"..Remsg.sender.user_id)
Redis:del(TheMero.."khesstime"..Remsg.sender.user_id)
Redis:del(TheMero.."khessnum"..Remsg.sender.user_id)
Redis:del(TheMero.."khessname"..Remsg.sender.user_id)
Redis:del(TheMero.."kheartime"..Remsg.sender.user_id)
Redis:del(TheMero.."khearnum"..Remsg.sender.user_id)
Redis:del(TheMero.."khearname"..Remsg.sender.user_id)
Redis:del(TheMero.."jzartime"..Remsg.sender.user_id)
Redis:del(TheMero.."jzarnum"..Remsg.sender.user_id)
Redis:del(TheMero.."jzarname"..Remsg.sender.user_id)
Redis:del(TheMero.."fleflatime"..Remsg.sender.user_id)
Redis:del(TheMero.."fleflanum"..Remsg.sender.user_id)
Redis:del(TheMero.."fleflaname"..Remsg.sender.user_id)
Redis:del(TheMero.."freaztime"..Remsg.sender.user_id)
Redis:del(TheMero.."freaznum"..Remsg.sender.user_id)
Redis:del(TheMero.."freazname"..Remsg.sender.user_id)
Redis:del(TheMero.."doratime"..Remsg.sender.user_id)
Redis:del(TheMero.."doranum"..Remsg.sender.user_id)
Redis:del(TheMero.."doraname"..Remsg.sender.user_id)
Redis:del(TheMero.."tomtime"..Remsg.sender.user_id)
Redis:del(TheMero.."tomnum"..Remsg.sender.user_id)
Redis:del(TheMero.."tomname"..Remsg.sender.user_id)
Redis:del(TheMero.."ftrtime"..Remsg.sender.user_id)
Redis:del(TheMero.."ftrnum"..Remsg.sender.user_id)
Redis:del(TheMero.."ftrname"..Remsg.sender.user_id)
Redis:del(TheMero.."tfahtime"..Remsg.sender.user_id)
Redis:del(TheMero.."tfahnum"..Remsg.sender.user_id)
Redis:del(TheMero.."tfahname"..Remsg.sender.user_id)
Redis:del(TheMero.."enabtime"..Remsg.sender.user_id)
Redis:del(TheMero.."enabnum"..Remsg.sender.user_id)
Redis:del(TheMero.."enabname"..Remsg.sender.user_id)
Redis:del(TheMero.."zetontime"..Remsg.sender.user_id)
Redis:del(TheMero.."zetonnum"..Remsg.sender.user_id)
Redis:del(TheMero.."zetonname"..Remsg.sender.user_id)
Redis:del(TheMero.."mozztime"..Remsg.sender.user_id)
Redis:del(TheMero.."mozznum"..Remsg.sender.user_id)
Redis:del(TheMero.."mozzname"..Remsg.sender.user_id)
Redis:del(TheMero.."mangatime"..Remsg.sender.user_id)
Redis:del(TheMero.."manganum"..Remsg.sender.user_id)
Redis:del(TheMero.."manganame"..Remsg.sender.user_id)
Redis:del(TheMero.."sizefram"..Remsg.sender.user_id)
Redis:del(TheMero.."namefram"..Remsg.sender.user_id)
Redis:del(TheMero.."mzroatsize"..Remsg.sender.user_id)
Redis:srem(TheMero.."farmarname", namfra)
Redis:srem(TheMero.."ownerfram",Remsg.sender.user_id)
namenad = Redis:get(TheMero.."lkbnade"..Remsg.sender.user_id)
Redis:del(TheMero.."namenade"..Remsg.sender.user_id)
Redis:del(TheMero.."nokatnade"..Remsg.sender.user_id)
Redis:del(TheMero.."energynade"..Remsg.sender.user_id)
Redis:del(TheMero.."traningnade"..Remsg.sender.user_id)
Redis:del(TheMero.."nameplayer".."1"..Remsg.sender.user_id)
Redis:del(TheMero.."nameplayer".."2"..Remsg.sender.user_id)
Redis:del(TheMero.."nameplayer".."3"..Remsg.sender.user_id)
Redis:del(TheMero.."nameplayer".."4"..Remsg.sender.user_id)
Redis:del(TheMero.."nameplayer".."5"..Remsg.sender.user_id)
Redis:del(TheMero.."energyplayer".."1"..Remsg.sender.user_id)
Redis:del(TheMero.."energyplayer".."2"..Remsg.sender.user_id)
Redis:del(TheMero.."energyplayer".."3"..Remsg.sender.user_id)
Redis:del(TheMero.."energyplayer".."4"..Remsg.sender.user_id)
Redis:del(TheMero.."energyplayer".."5"..Remsg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."1"..Remsg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."2"..Remsg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."3"..Remsg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."4"..Remsg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."5"..Remsg.sender.user_id)
Redis:del(TheMero.."cityplayer".."1"..Remsg.sender.user_id)
Redis:del(TheMero.."cityplayer".."2"..Remsg.sender.user_id)
Redis:del(TheMero.."cityplayer".."3"..Remsg.sender.user_id)
Redis:del(TheMero.."cityplayer".."4"..Remsg.sender.user_id)
Redis:del(TheMero.."cityplayer".."5"..Remsg.sender.user_id)
Redis:del(TheMero.."priceplayer".."1"..Remsg.sender.user_id)
Redis:del(TheMero.."priceplayer".."2"..Remsg.sender.user_id)
Redis:del(TheMero.."priceplayer".."3"..Remsg.sender.user_id)
Redis:del(TheMero.."priceplayer".."4"..Remsg.sender.user_id)
Redis:del(TheMero.."priceplayer".."5"..Remsg.sender.user_id)
Redis:srem(TheMero.."lkbnadesadd", namenad)
Redis:srem(TheMero.."ownernade",Remsg.sender.user_id)
Redis:del(TheMero.."lkbnade"..Remsg.sender.user_id)
...
ppppp = Redis:get(TheMero.."rrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender.user_id) or 0
shkse = Redis:get(TheMero.."shkse"..Remsg.sender.user_id)
doltebank = Redis:get(TheMero.."doltebank"..Remsg.sender.user_id)
local convert_mony = string.format("%.0f",ballanceed)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
morakba = tonumber(Redis:get(TheMero.."morakba"..msg.sender.user_id))
if morakba == msg.sender.user_id then
send("-1001737102093",0,"⇜ الايدي ↤ "..msg.sender.user_id.."\n⇜ القروب ↤ "..msg.chat_id.."\n⇜ الرسالة ↤ "..text.."\n✧","md",true)
end
...
Redis:set(TheMero.."boob"..msg.sender.user_id , cobonplus)
...
ballanceed = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
if Redis:ttl(TheMero.."iiooooo" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."iiooooo" .. msg.sender.user_id))
...
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(ballanceekkku))
Redis:setex(TheMero.."iiooooo" .. msg.sender.user_id,900, true)
...
ballanceed = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
if Redis:ttl(TheMero.."iioooo" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."iioooo" .. msg.sender.user_id))
...
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(ballanceekkk))
Redis:setex(TheMero.."iioooo" .. msg.sender.user_id,1200, true)
...
if text == 'سحب' then
ballanceed = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
if Redis:ttl(TheMero.."iioood" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."iioood" .. msg.sender.user_id))
...
if text == 'حظ' then
ballanceed = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
if Redis:ttl(TheMero.."iiooo" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."iiooo" .. msg.sender.user_id))
...
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(TheMero.."iiooo" .. msg.sender.user_id,900, true)
...
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(ballanceekk))
Redis:setex(TheMero.."iiooo" .. msg.sender.user_id,900, true)
...
if text == 'تحويل' then
if Redis:ttl(TheMero.."tanstime" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."tanstime" .. msg.sender.user_id))
...
local coniss = coin(UserName)
if not Redis:sismember(TheMero.."booob",msg.sender.user_id) then
...
Redis:set(TheMero.."transn"..msg.sender.user_id,coniss)
Redis:setex(TheMero.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(TheMero.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(TheMero.."boobb"..msg.sender.user_id)
uuuu = Redis:get(TheMero.."bbobb"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(TheMero.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(TheMero.."transn" .. msg.sender.user_id)
...
local UserNamey = Redis:get(TheMero.."transn"..msg.sender.user_id)
local ban = bot.getUser(msg.sender.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(deccde))
decdecb = Redis:get(TheMero.."boob"..fsvhhh) or 0
deccde2 = decdecb + UserNameyy
Redis:set(TheMero.."boob"..fsvhhh , math.floor(deccde2))
Redis:setex(TheMero.."tanstime" .. msg.sender.user_id,1800, true)
...
data = {
{
{text = 'توب الفلوس', data = msg.sender.user_id..'/topmon'}, {text = 'توب الحراميه', data = msg.sender.user_id..'/topzrf'},
},
{
{text = 'توب المتزوجين', data = msg.sender.user_id..'/zoztee'}, {text = 'توب المتبرعين', data = msg.sender.user_id..'/motbra'},
},
{
{text = 'توب النوادي', data = msg.sender.user_id..'/topnade'},{text = 'توب المزارع', data = msg.sender.user_id..'/mazratee'},
},
{
...
zrfee = Redis:get(TheMero.."rrfff"..msg.sender.user_id) or 0
...
if Redis:ttl(TheMero.."iioo" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."iioo" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"⇜ من شوي اخذت رشوة استنى "..time.." ","md",true)
end
if Redis:ttl(TheMero.."polrsho" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."polrsho" .. msg.sender.user_id))
...
Redis:set(TheMero.."boob"..msg.sender.user_id , bakigcj)
send(msg.chat_id,msg.id,"⇜ هذه رشوة بطل زرف "..jjjo.." درهم 💵","md",true)
Redis:setex(TheMero.."iioo" .. msg.sender.user_id,600, true)
else
Redis:setex(TheMero.."polrsho" .. msg.sender.user_id,300, true)
...
if Redis:ttl(TheMero.."polic" .. msg.sender.user_id) >=60 then
local hours = Redis:ttl(TheMero.."polic" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id,"⇜ انتا بالسجن 🏤 استنى "..math.floor(hours).." دقائق\n✧","md",true)
end
if Redis:ttl(TheMero.."hrame" .. Remsg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."hrame" .. Remsg.sender.user_id))
...
shkseto = Redis:get(TheMero.."shkse"..Remsg.sender.user_id)
if shkseto == "طيبة" then
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = Redis:get(TheMero.."boob"..Remsg.sender.user_id) or 0
local ballancope = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
zrfne = ballanceed - hrame
zrfnee = ballancope + hrame
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(zrfnee))
Redis:set(TheMero.."boob"..Remsg.sender.user_id , math.floor(zrfne))
Redis:setex(TheMero.."hrame" .. Remsg.sender.user_id,600, true)
local zoropeo = Redis:get(TheMero.."rrfff"..msg.sender.user_id) or 0
zoroprod = zoropeo + hrame
Redis:set(TheMero.."rrfff"..msg.sender.user_id,zoroprod)
Redis:sadd(TheMero.."rrfffid",msg.sender.user_id)
local ban = bot.getUser(Remsg.sender.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(TheMero.."msrokid"..msg.chat_id..Remsg.sender.user_id,Remsg.sender.user_id)
Redis:set(TheMero.."hrameid"..msg.chat_id..Remsg.sender.user_id,msg.sender.user_id)
Redis:set(TheMero.."balcmsrok"..msg.chat_id..Remsg.sender.user_id,hrame)
Redis:setex(TheMero.."timehrame"..msg.chat_id..msg.sender.user_id,30, true)
...
local hrameid = Redis:get(TheMero.."hrameid"..msg.chat_id..msg.sender.user_id)
shkse = Redis:get(TheMero.."shkse"..msg.sender.user_id)
if shkse == "شريرة" then
...
local msrokid = Redis:get(TheMero.."msrokid"..msg.chat_id..msg.sender.user_id)
local hrameid = Redis:get(TheMero.."hrameid"..msg.chat_id..msg.sender.user_id)
local balcmsrok = Redis:get(TheMero.."balcmsrok"..msg.chat_id..msg.sender.user_id) or 0
...
Redis:del(TheMero.."msrokid" ..msg.chat_id..msg.sender.user_id) 
Redis:del(TheMero.."hrameid" ..msg.chat_id..msg.sender.user_id) 
Redis:del(TheMero.."balcmsrok" ..msg.chat_id..msg.sender.user_id) 
Redis:del(TheMero.."timehrame" ..msg.chat_id..msg.sender.user_id)
...
if Redis:ttl(TheMero.."iiioo" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."iiioo" .. msg.sender.user_id))
...
local ballancee = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
shkse = Redis:get(TheMero.."shkse"..msg.sender.user_id)
ratbinc = Redis:get(TheMero.."ratbinc"..msg.sender.user_id) or 1
ratbtrans = Redis:get(TheMero.."ratbtrans"..msg.sender.user_id) or 1
if shkse == "طيبة" then
if tonumber(ratbinc) >= 270 and tonumber(ratbtrans) == 10 then
local ratpep = ballancee + 500000
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(ratpep))
local ballancee = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:setex(TheMero.."iiioo" .. msg.sender.user_id,600, true)
Redis:incrby(TheMero.."ratbinc"..msg.sender.user_id,1)
ratbinc = Redis:get(TheMero.."ratbinc"..msg.sender.user_id)
...
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,300)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500000 درهم 💵\n⇜ وظيفتك : ملك 👑\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : `"..convert_mony.."` درهم 💵\n✧","md",true)
end
...
Redis:setex(TheMero.."iiioo" .. msg.sender.user_id,600, true)
Redis:incrby(TheMero.."ratbinc"..msg.sender.user_id,1)
ratbinc = Redis:get(TheMero.."ratbinc"..msg.sender.user_id) or 0
if tonumber(ratbinc) == 270 or tonumber(ratbinc) == 271 then
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,270)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,240)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,210)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 70000 درهم 💵\n⇜ وظيفتك : بزنس مان كبير 💸\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,180)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,150)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,120)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,90)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,60)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(TheMero.."ratbinc"..msg.sender.user_id,30)
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:set(TheMero.."ratbtrans"..msg.sender.user_id,10)
nowbalc = tonumber(ballancee) - 1000000000
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(nowbalc))
...
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:set(TheMero.."ratbtrans"..msg.sender.user_id,9)
...
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:set(TheMero.."ratbtrans"..msg.sender.user_id,8)
...
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:set(TheMero.."ratbtrans"..msg.sender.user_id,7)
...
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:set(TheMero.."ratbtrans"..msg.sender.user_id,6)
...
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:set(TheMero.."ratbtrans"..msg.sender.user_id,5)
...
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:set(TheMero.."ratbtrans"..msg.sender.user_id,4)
...
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:set(TheMero.."ratbtrans"..msg.sender.user_id,3)
...
Redis:del(TheMero.."ratbtrans"..msg.sender.user_id)
Redis:set(TheMero.."ratbtrans"..msg.sender.user_id,2)
...
if Redis:ttl(TheMero.."attack" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."attack" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"⇜ خسرت بأخر معركة استنى "..time.." ","md",true)
end
if Redis:ttl(TheMero.."defen" .. Remsg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."defen" .. Remsg.sender.user_id))
return send(msg.chat_id,msg.id,"⇜ الخصم خسر بأخر معركة\n⇜ يمديك تهاجمه بعد "..time.." ","md",true)
end
if Redis:sismember(TheMero.."booob",Remsg.sender.user_id) then
ballancope = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender.user_id) or 0
...
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(zrfne))
Redis:set(TheMero.."boob"..Remsg.sender.user_id , math.floor(zrfnee))
Redis:setex(TheMero.."attack" .. msg.sender.user_id,600, true)
...
local ballanceed = Redis:get(TheMero.."boob"..Remsg.sender.user_id) or 0
local ballancope = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
begaatt = Redis:get(TheMero.."numattack"..msg.sender.user_id) or 200
...
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(zrfne))
Redis:set(TheMero.."boob"..Remsg.sender.user_id , math.floor(zrfnee))
Redis:setex(TheMero.."defen" .. Remsg.sender.user_id,1800, true)
Redis:set(TheMero.."numattack"..msg.sender.user_id , math.floor(numattackk))
...
Redis:setex(TheMero.."marad" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if text == "سيارات" and Redis:get(TheMero.."marad" .. msg.chat_id .. ":" .. msg.sender.user_id) then
Redis:del(TheMero.."marad" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "طيارات" and Redis:get(TheMero.."marad" .. msg.chat_id .. ":" .. msg.sender.user_id) then
Redis:del(TheMero.."marad" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "عقارات" and Redis:get(TheMero.."marad" .. msg.chat_id .. ":" .. msg.sender.user_id) then
Redis:del(TheMero.."marad" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "مجوهرات" and Redis:get(TheMero.."marad" .. msg.chat_id .. ":" .. msg.sender.user_id) then
Redis:del(TheMero.."marad" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id,[[
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
...
local mgrmasname = Redis:get(TheMero.."mgrmasname"..msg.sender.user_id)
local mgrmasprice = Redis:get(TheMero.."mgrmasprice"..msg.sender.user_id) or 0
local mgrmasnum = Redis:get(TheMero.."mgrmasnum"..msg.sender.user_id) or 0
local mgrmasnow = tonumber(mgrmasnum) + tonumber(coniss)
Redis:set(TheMero.."mgrmasnum"..msg.sender.user_id , mgrmasnow)
masnamed = "ماسه"
Redis:set(TheMero.."mgrmasname"..msg.sender.user_id , masnamed)
Redis:set(TheMero.."mgrmasprice"..msg.sender.user_id , 1000000)
totalypalice = tonumber(ballance) - tonumber(masmgr)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
...
local mgrkldname = Redis:get(TheMero.."mgrkldname"..msg.sender.user_id)
local mgrkldprice = Redis:get(TheMero.."mgrkldprice"..msg.sender.user_id) or 0
local mgrkldnum = Redis:get(TheMero.."mgrkldnum"..msg.sender.user_id) or 0
local mgrkldnow = tonumber(mgrkldnum) + tonumber(coniss)
Redis:set(TheMero.."mgrkldnum"..msg.sender.user_id , mgrkldnow)
kldnamed = "قلاده"
Redis:set(TheMero.."mgrkldname"..msg.sender.user_id , kldnamed)
Redis:set(TheMero.."mgrkldprice"..msg.sender.user_id , 500000)
...
local mgrswrname = Redis:get(TheMero.."mgrswrname"..msg.sender.user_id)
local mgrswrprice = Redis:get(TheMero.."mgrswrprice"..msg.sender.user_id) or 0
local mgrswrnum = Redis:get(TheMero.."mgrswrnum"..msg.sender.user_id) or 0
local mgrswrnow = tonumber(mgrswrnum) + tonumber(coniss)
Redis:set(TheMero.."mgrswrnum"..msg.sender.user_id , mgrswrnow)
swrnamed = "سوار"
Redis:set(TheMero.."mgrswrname"..msg.sender.user_id , swrnamed)
Redis:set(TheMero.."mgrswrprice"..msg.sender.user_id , 200000)
...
local mgrktmname = Redis:get(TheMero.."mgrktmname"..msg.sender.user_id)
local mgrktmprice = Redis:get(TheMero.."mgrktmprice"..msg.sender.user_id) or 0
local mgrktmnum = Redis:get(TheMero.."mgrktmnum"..msg.sender.user_id) or 0
local mgrktmnow = tonumber(mgrktmnum) + tonumber(coniss)
Redis:set(TheMero.."mgrktmnum"..msg.sender.user_id , mgrktmnow)
ktmnamed = "خاتم"
Redis:set(TheMero.."mgrktmname"..msg.sender.user_id , ktmnamed)
Redis:set(TheMero.."mgrktmprice"..msg.sender.user_id , 50000)
...
Redis:set(TheMero.."boob"..msg.sender.user_id , totalypalice)
local convert_mony = string.format("%.0f",math.floor(totalypalice))
local mgrmasnum = Redis:get(TheMero.."mgrmasnum"..msg.sender.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(TheMero.."mgrmasname"..msg.sender.user_id)
...
if Redis:ttl(TheMero.."giftmmt" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."giftmmt" .. msg.sender.user_id))
...
local mgrmasnow = tonumber(mgrmasnum) - tonumber(coniss)
Redis:set(TheMero.."mgrmasnum"..msg.sender.user_id , mgrmasnow)
local mgrmasnumm = Redis:get(TheMero.."mgrmasnum"..Remsg.sender.user_id) or 0
local mgrmasnoww = tonumber(mgrmasnumm) + tonumber(coniss)
Redis:set(TheMero.."mgrmasnum"..Remsg.sender.user_id , mgrmasnoww)
masnamed = "ماسه"
Redis:set(TheMero.."mgrmasname"..Remsg.sender.user_id,masnamed)
local mgrmasnum = Redis:get(TheMero.."mgrmasnum"..msg.sender.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(TheMero.."mgrmasname"..msg.sender.user_id)
Redis:del(TheMero.."mgrmasnum"..msg.sender.user_id)
end
Redis:setex(TheMero.."giftmmt" .. msg.sender.user_id,1800, true)
...
local mgrkldnow = tonumber(mgrkldnum) - tonumber(coniss)
Redis:set(TheMero.."mgrkldnum"..msg.sender.user_id , mgrkldnow)
local mgrkldnumm = Redis:get(TheMero.."mgrkldnum"..Remsg.sender.user_id) or 0
local mgrkldnoww = tonumber(mgrkldnumm) + tonumber(coniss)
Redis:set(TheMero.."mgrkldnum"..Remsg.sender.user_id , mgrkldnoww)
kldnamed = "قلاده"
Redis:set(TheMero.."mgrkldname"..Remsg.sender.user_id,kldnamed)
local mgrkldnum = Redis:get(TheMero.."mgrkldnum"..msg.sender.user_id) or 0
if tonumber(mgrkldnum) == 0 then
Redis:del(TheMero.."mgrkldname"..msg.sender.user_id)
Redis:del(TheMero.."mgrkldnum"..msg.sender.user_id)
...
local mgrswrnow = tonumber(mgrswrnum) - tonumber(coniss)
Redis:set(TheMero.."mgrswrnum"..msg.sender.user_id , mgrswrnow)
local mgrswrnumm = Redis:get(TheMero.."mgrswrnum"..Remsg.sender.user_id) or 0
local mgrswrnoww = tonumber(mgrswrnumm) + tonumber(coniss)
Redis:set(TheMero.."mgrswrnum"..Remsg.sender.user_id , mgrswrnoww)
swrnamed = "سوار"
Redis:set(TheMero.."mgrswrname"..Remsg.sender.user_id,swrnamed)
local mgrswrnum = Redis:get(TheMero.."mgrswrnum"..msg.sender.user_id) or 0
if tonumber(mgrswrnum) == 0 then
Redis:del(TheMero.."mgrswrname"..msg.sender.user_id)
Redis:del(TheMero.."mgrswrnum"..msg.sender.user_id)
...
local mgrktmnow = tonumber(mgrktmnum) - tonumber(coniss)
Redis:set(TheMero.."mgrktmnum"..msg.sender.user_id , mgrktmnow)
local mgrktmnumm = Redis:get(TheMero.."mgrktmnum"..Remsg.sender.user_id) or 0
local mgrktmnoww = tonumber(mgrktmnumm) + tonumber(coniss)
Redis:set(TheMero.."mgrktmnum"..Remsg.sender.user_id , mgrktmnoww)
ktmnamed = "خاتم"
Redis:set(TheMero.."mgrktmname"..Remsg.sender.user_id,ktmnamed)
local mgrktmnum = Redis:get(TheMero.."mgrktmnum"..msg.sender.user_id) or 0
if tonumber(mgrktmnum) == 0 then
Redis:del(TheMero.."mgrktmname"..msg.sender.user_id)
Redis:del(TheMero.."mgrktmnum"..msg.sender.user_id)
...
local akrksrname = Redis:get(TheMero.."akrksrname"..msg.sender.user_id)
local akrksrprice = Redis:get(TheMero.."akrksrprice"..msg.sender.user_id) or 0
local akrksrnum = Redis:get(TheMero.."akrksrnum"..msg.sender.user_id) or 0
local akrksrnow = tonumber(akrksrnum) + tonumber(coniss)
Redis:set(TheMero.."akrksrnum"..msg.sender.user_id , akrksrnow)
ksrnamed = "قصر"
Redis:set(TheMero.."akrksrname"..msg.sender.user_id , ksrnamed)
Redis:set(TheMero.."akrksrprice"..msg.sender.user_id , 1000000)
...
local akrfelname = Redis:get(TheMero.."akrfelname"..msg.sender.user_id)
local akrfelprice = Redis:get(TheMero.."akrfelprice"..msg.sender.user_id) or 0
local akrfelnum = Redis:get(TheMero.."akrfelnum"..msg.sender.user_id) or 0
local akrfelnow = tonumber(akrfelnum) + tonumber(coniss)
Redis:set(TheMero.."akrfelnum"..msg.sender.user_id , akrfelnow)
felnamed = "فيلا"
Redis:set(TheMero.."akrfelname"..msg.sender.user_id , felnamed)
Redis:set(TheMero.."akrfelprice"..msg.sender.user_id , 500000)
...
local akrmnzname = Redis:get(TheMero.."akrmnzname"..msg.sender.user_id)
local akrmnzprice = Redis:get(TheMero.."akrmnzprice"..msg.sender.user_id) or 0
local akrmnznum = Redis:get(TheMero.."akrmnznum"..msg.sender.user_id) or 0
local akrmnznow = tonumber(akrmnznum) + tonumber(coniss)
Redis:set(TheMero.."akrmnznum"..msg.sender.user_id , akrmnznow)
mnznamed = "منزل"
Redis:set(TheMero.."akrmnzname"..msg.sender.user_id , mnznamed)
Redis:set(TheMero.."akrmnzprice"..msg.sender.user_id , 200000)
...
local akrksrnow = tonumber(akrksrnum) - tonumber(coniss)
Redis:set(TheMero.."akrksrnum"..msg.sender.user_id , akrksrnow)
local akrksrnumm = Redis:get(TheMero.."akrksrnum"..Remsg.sender.user_id) or 0
local akrksrnoww = tonumber(akrksrnumm) + tonumber(coniss)
Redis:set(TheMero.."akrksrnum"..Remsg.sender.user_id , akrksrnoww)
ksrnamed = "قصر"
Redis:set(TheMero.."akrksrname"..Remsg.sender.user_id,ksrnamed)
local akrksrnum = Redis:get(TheMero.."akrksrnum"..msg.sender.user_id) or 0
if tonumber(akrksrnum) == 0 then
Redis:del(TheMero.."akrksrname"..msg.sender.user_id)
Redis:del(TheMero.."akrksrnum"..msg.sender.user_id)
...
local akrfelnow = tonumber(akrfelnum) - tonumber(coniss)
Redis:set(TheMero.."akrfelnum"..msg.sender.user_id , akrfelnow)
local akrfelnumm = Redis:get(TheMero.."akrfelnum"..Remsg.sender.user_id) or 0
local akrfelnoww = tonumber(akrfelnumm) + tonumber(coniss)
Redis:set(TheMero.."akrfelnum"..Remsg.sender.user_id , akrfelnoww)
felnamed = "فيلا"
Redis:set(TheMero.."akrfelname"..Remsg.sender.user_id,felnamed)
local akrfelnum = Redis:get(TheMero.."akrfelnum"..msg.sender.user_id) or 0
if tonumber(akrfelnum) == 0 then
Redis:del(TheMero.."akrfelname"..msg.sender.user_id)
Redis:del(TheMero.."akrfelnum"..msg.sender.user_id)
...
local akrmnznow = tonumber(akrmnznum) - tonumber(coniss)
Redis:set(TheMero.."akrmnznum"..msg.sender.user_id , akrmnznow)
local akrmnznumm = Redis:get(TheMero.."akrmnznum"..Remsg.sender.user_id) or 0
local akrmnznoww = tonumber(akrmnznumm) + tonumber(coniss)
Redis:set(TheMero.."akrmnznum"..Remsg.sender.user_id , akrmnznoww)
mnznamed = "منزل"
Redis:set(TheMero.."akrmnzname"..Remsg.sender.user_id,mnznamed)
local akrmnznum = Redis:get(TheMero.."akrmnznum"..msg.sender.user_id) or 0
if tonumber(akrmnznum) == 0 then
Redis:del(TheMero.."akrmnzname"..msg.sender.user_id)
Redis:del(TheMero.."akrmnznum"..msg.sender.user_id)
...
local airshbhname = Redis:get(TheMero.."airshbhname"..msg.sender.user_id)
local airshbhprice = Redis:get(TheMero.."airshbhprice"..msg.sender.user_id) or 0
local airshbhnum = Redis:get(TheMero.."airshbhnum"..msg.sender.user_id) or 0
local airshbhnow = tonumber(airshbhnum) + tonumber(coniss)
Redis:set(TheMero.."airshbhnum"..msg.sender.user_id , airshbhnow)
shbhnamed = "شبح"
Redis:set(TheMero.."airshbhname"..msg.sender.user_id , shbhnamed)
Redis:set(TheMero.."airshbhprice"..msg.sender.user_id , 1000000000)
...
local airsfarname = Redis:get(TheMero.."airsfarname"..msg.sender.user_id)
local airsfarprice = Redis:get(TheMero.."airsfarprice"..msg.sender.user_id) or 0
local airsfarnum = Redis:get(TheMero.."airsfarnum"..msg.sender.user_id) or 0
local airsfarnow = tonumber(airsfarnum) + tonumber(coniss)
Redis:set(TheMero.."airsfarnum"..msg.sender.user_id , airsfarnow)
sfarnamed = "سفر"
Redis:set(TheMero.."airsfarname"..msg.sender.user_id , sfarnamed)
Redis:set(TheMero.."airsfarprice"..msg.sender.user_id , 500000000)
...
local airkhasname = Redis:get(TheMero.."airkhasname"..msg.sender.user_id)
local airkhasprice = Redis:get(TheMero.."airkhasprice"..msg.sender.user_id) or 0
local airkhasnum = Redis:get(TheMero.."airkhasnum"..msg.sender.user_id) or 0
local airkhasnow = tonumber(airkhasnum) + tonumber(coniss)
Redis:set(TheMero.."airkhasnum"..msg.sender.user_id , airkhasnow)
khasnamed = "خاصه"
Redis:set(TheMero.."airkhasname"..msg.sender.user_id , khasnamed)
Redis:set(TheMero.."airkhasprice"..msg.sender.user_id , 200000000)
...
local airshbhnow = tonumber(airshbhnum) - tonumber(coniss)
Redis:set(TheMero.."airshbhnum"..msg.sender.user_id , airshbhnow)
local airshbhnumm = Redis:get(TheMero.."airshbhnum"..Remsg.sender.user_id) or 0
local airshbhnoww = tonumber(airshbhnumm) + tonumber(coniss)
Redis:set(TheMero.."airshbhnum"..Remsg.sender.user_id , airshbhnoww)
shbhnamed = "شبح"
Redis:set(TheMero.."airshbhname"..Remsg.sender.user_id,shbhnamed)
local airshbhnum = Redis:get(TheMero.."airshbhnum"..msg.sender.user_id) or 0
if tonumber(airshbhnum) == 0 then
Redis:del(TheMero.."airshbhname"..msg.sender.user_id)
Redis:del(TheMero.."airshbhnum"..msg.sender.user_id)
...
local airsfarnow = tonumber(airsfarnum) - tonumber(coniss)
Redis:set(TheMero.."airsfarnum"..msg.sender.user_id , airsfarnow)
local airsfarnumm = Redis:get(TheMero.."airsfarnum"..Remsg.sender.user_id) or 0
local airsfarnoww = tonumber(airsfarnumm) + tonumber(coniss)
Redis:set(TheMero.."airsfarnum"..Remsg.sender.user_id , airsfarnoww)
sfarnamed = "سفر"
Redis:set(TheMero.."airsfarname"..Remsg.sender.user_id,sfarnamed)
local airsfarnum = Redis:get(TheMero.."airsfarnum"..msg.sender.user_id) or 0
if tonumber(airsfarnum) == 0 then
Redis:del(TheMero.."airsfarname"..msg.sender.user_id)
Redis:del(TheMero.."airsfarnum"..msg.sender.user_id)
...
local airkhasnow = tonumber(airkhasnum) - tonumber(coniss)
Redis:set(TheMero.."airkhasnum"..msg.sender.user_id , airkhasnow)
local airkhasnumm = Redis:get(TheMero.."airkhasnum"..Remsg.sender.user_id) or 0
local airkhasnoww = tonumber(airkhasnumm) + tonumber(coniss)
Redis:set(TheMero.."airkhasnum"..Remsg.sender.user_id , airkhasnoww)
khasnamed = "خاصه"
Redis:set(TheMero.."airkhasname"..Remsg.sender.user_id,khasnamed)
local airkhasnum = Redis:get(TheMero.."airkhasnum"..msg.sender.user_id) or 0
if tonumber(airkhasnum) == 0 then
Redis:del(TheMero.."airkhasname"..msg.sender.user_id)
Redis:del(TheMero.."airkhasnum"..msg.sender.user_id)
...
local carrangname = Redis:get(TheMero.."carrangname"..msg.sender.user_id)
local carrangprice = Redis:get(TheMero.."carrangprice"..msg.sender.user_id) or 0
local carrangnum = Redis:get(TheMero.."carrangnum"..msg.sender.user_id) or 0
local carrangnow = tonumber(carrangnum) + tonumber(coniss)
Redis:set(TheMero.."carrangnum"..msg.sender.user_id , carrangnow)
rangnamed = "فيلار"
Redis:set(TheMero.."carrangname"..msg.sender.user_id , rangnamed)
Redis:set(TheMero.."carrangprice"..msg.sender.user_id , 10000000)
...
local caraccename = Redis:get(TheMero.."caraccename"..msg.sender.user_id)
local caracceprice = Redis:get(TheMero.."caracceprice"..msg.sender.user_id) or 0
local caraccenum = Redis:get(TheMero.."caraccenum"..msg.sender.user_id) or 0
local caraccenow = tonumber(caraccenum) + tonumber(coniss)
Redis:set(TheMero.."caraccenum"..msg.sender.user_id , caraccenow)
accenamed = "اكسنت"
Redis:set(TheMero.."caraccename"..msg.sender.user_id , accenamed)
Redis:set(TheMero.."caracceprice"..msg.sender.user_id , 9000000)
...
local carcamrname = Redis:get(TheMero.."carcamrname"..msg.sender.user_id)
local carcamrprice = Redis:get(TheMero.."carcamrprice"..msg.sender.user_id) or 0
local carcamrnum = Redis:get(TheMero.."carcamrnum"..msg.sender.user_id) or 0
local carcamrnow = tonumber(carcamrnum) + tonumber(coniss)
Redis:set(TheMero.."carcamrnum"..msg.sender.user_id , carcamrnow)
camrnamed = "كامري"
Redis:set(TheMero.."carcamrname"..msg.sender.user_id , camrnamed)
Redis:set(TheMero.."carcamrprice"..msg.sender.user_id , 8000000)
...
local caralntrname = Redis:get(TheMero.."caralntrname"..msg.sender.user_id)
local caralntrprice = Redis:get(TheMero.."caralntrprice"..msg.sender.user_id) or 0
local caralntrnum = Redis:get(TheMero.."caralntrnum"..msg.sender.user_id) or 0
local caralntrnow = tonumber(caralntrnum) + tonumber(coniss)
Redis:set(TheMero.."caralntrnum"..msg.sender.user_id , caralntrnow)
alntrnamed = "النترا"
Redis:set(TheMero.."caralntrname"..msg.sender.user_id , alntrnamed)
Redis:set(TheMero.."caralntrprice"..msg.sender.user_id , 7000000)
...
local carhilxname = Redis:get(TheMero.."carhilxname"..msg.sender.user_id)
local carhilxprice = Redis:get(TheMero.."carhilxprice"..msg.sender.user_id) or 0
local carhilxnum = Redis:get(TheMero.."carhilxnum"..msg.sender.user_id) or 0
local carhilxnow = tonumber(carhilxnum) + tonumber(coniss)
Redis:set(TheMero.."carhilxnum"..msg.sender.user_id , carhilxnow)
hilxnamed = "هايلكس"
Redis:set(TheMero.."carhilxname"..msg.sender.user_id , hilxnamed)
Redis:set(TheMero.."carhilxprice"..msg.sender.user_id , 6000000)
...
local carsonaname = Redis:get(TheMero.."carsonaname"..msg.sender.user_id)
local carsonaprice = Redis:get(TheMero.."carsonaprice"..msg.sender.user_id) or 0
local carsonanum = Redis:get(TheMero.."carsonanum"..msg.sender.user_id) or 0
local carsonanow = tonumber(carsonanum) + tonumber(coniss)
Redis:set(TheMero.."carsonanum"..msg.sender.user_id , carsonanow)
sonanamed = "سوناتا"
Redis:set(TheMero.."carsonaname"..msg.sender.user_id , sonanamed)
Redis:set(TheMero.."carsonaprice"..msg.sender.user_id , 5000000)
...
local carcoroname = Redis:get(TheMero.."carcoroname"..msg.sender.user_id)
local carcoroprice = Redis:get(TheMero.."carcoroprice"..msg.sender.user_id) or 0
local carcoronum = Redis:get(TheMero.."carcoronum"..msg.sender.user_id) or 0
local carcoronow = tonumber(carcoronum) + tonumber(coniss)
Redis:set(TheMero.."carcoronum"..msg.sender.user_id , carcoronow)
coronamed = "كورولا"
Redis:set(TheMero.."carcoroname"..msg.sender.user_id , coronamed)
Redis:set(TheMero.."carcoroprice"..msg.sender.user_id , 4000000)
...
local carrangnow = tonumber(carrangnum) - tonumber(coniss)
Redis:set(TheMero.."carrangnum"..msg.sender.user_id , carrangnow)
local carrangnumm = Redis:get(TheMero.."carrangnum"..Remsg.sender.user_id) or 0
local carrangnoww = tonumber(carrangnumm) + tonumber(coniss)
Redis:set(TheMero.."carrangnum"..Remsg.sender.user_id , carrangnoww)
rangnamed = "فيلار"
Redis:set(TheMero.."carrangname"..Remsg.sender.user_id,rangnamed)
local carrangnum = Redis:get(TheMero.."carrangnum"..msg.sender.user_id) or 0
if tonumber(carrangnum) == 0 then
Redis:del(TheMero.."carrangname"..msg.sender.user_id)
Redis:del(TheMero.."carrangnum"..msg.sender.user_id)
...
local caraccenow = tonumber(caraccenum) - tonumber(coniss)
Redis:set(TheMero.."caraccenum"..msg.sender.user_id , caraccenow)
local caraccenumm = Redis:get(TheMero.."caraccenum"..Remsg.sender.user_id) or 0
local caraccenoww = tonumber(caraccenumm) + tonumber(coniss)
Redis:set(TheMero.."caraccenum"..Remsg.sender.user_id , caraccenoww)
accenamed = "اكسنت"
Redis:set(TheMero.."caraccename"..Remsg.sender.user_id,accenamed)
local caraccenum = Redis:get(TheMero.."caraccenum"..msg.sender.user_id) or 0
if tonumber(caraccenum) == 0 then
Redis:del(TheMero.."caraccename"..msg.sender.user_id)
Redis:del(TheMero.."caraccenum"..msg.sender.user_id)
...
local carcamrnow = tonumber(carcamrnum) - tonumber(coniss)
Redis:set(TheMero.."carcamrnum"..msg.sender.user_id , carcamrnow)
local carcamrnumm = Redis:get(TheMero.."carcamrnum"..Remsg.sender.user_id) or 0
local carcamrnoww = tonumber(carcamrnumm) + tonumber(coniss)
Redis:set(TheMero.."carcamrnum"..Remsg.sender.user_id , carcamrnoww)
camrnamed = "كامري"
Redis:set(TheMero.."carcamrname"..Remsg.sender.user_id,camrnamed)
local carcamrnum = Redis:get(TheMero.."carcamrnum"..msg.sender.user_id) or 0
if tonumber(carcamrnum) == 0 then
Redis:del(TheMero.."carcamrname"..msg.sender.user_id)
Redis:del(TheMero.."carcamrnum"..msg.sender.user_id)
...
local carhilxnow = tonumber(carhilxnum) - tonumber(coniss)
Redis:set(TheMero.."carhilxnum"..msg.sender.user_id , carhilxnow)
local carhilxnumm = Redis:get(TheMero.."carhilxnum"..Remsg.sender.user_id) or 0
local carhilxnoww = tonumber(carhilxnumm) + tonumber(coniss)
Redis:set(TheMero.."carhilxnum"..Remsg.sender.user_id , carhilxnoww)
hilxnamed = "هايلكس"
Redis:set(TheMero.."carhilxname"..Remsg.sender.user_id,hilxnamed)
local carhilxnum = Redis:get(TheMero.."carhilxnum"..msg.sender.user_id) or 0
if tonumber(carhilxnum) == 0 then
Redis:del(TheMero.."carhilxname"..msg.sender.user_id)
Redis:del(TheMero.."carhilxnum"..msg.sender.user_id)
...
local caralntrnow = tonumber(caralntrnum) - tonumber(coniss)
Redis:set(TheMero.."caralntrnum"..msg.sender.user_id , caralntrnow)
local caralntrnumm = Redis:get(TheMero.."caralntrnum"..Remsg.sender.user_id) or 0
local caralntrnoww = tonumber(caralntrnumm) + tonumber(coniss)
Redis:set(TheMero.."caralntrnum"..Remsg.sender.user_id , caralntrnoww)
alntrnamed = "النترا"
Redis:set(TheMero.."caralntrname"..Remsg.sender.user_id,alntrnamed)
local caralntrnum = Redis:get(TheMero.."caralntrnum"..msg.sender.user_id) or 0
if tonumber(caralntrnum) == 0 then
Redis:del(TheMero.."caralntrname"..msg.sender.user_id)
Redis:del(TheMero.."caralntrnum"..msg.sender.user_id)
...
local carsonanow = tonumber(carsonanum) - tonumber(coniss)
Redis:set(TheMero.."carsonanum"..msg.sender.user_id , carsonanow)
local carsonanumm = Redis:get(TheMero.."carsonanum"..Remsg.sender.user_id) or 0
local carsonanoww = tonumber(carsonanumm) + tonumber(coniss)
Redis:set(TheMero.."carsonanum"..Remsg.sender.user_id , carsonanoww)
sonanamed = "سوناتا"
Redis:set(TheMero.."carsonaname"..Remsg.sender.user_id,sonanamed)
local carsonanum = Redis:get(TheMero.."carsonanum"..msg.sender.user_id) or 0
if tonumber(carsonanum) == 0 then
Redis:del(TheMero.."carsonaname"..msg.sender.user_id)
Redis:del(TheMero.."carsonanum"..msg.sender.user_id)
...
local carcoronow = tonumber(carcoronum) - tonumber(coniss)
Redis:set(TheMero.."carcoronum"..msg.sender.user_id , carcoronow)
local carcoronumm = Redis:get(TheMero.."carcoronum"..Remsg.sender.user_id) or 0
local carcoronoww = tonumber(carcoronumm) + tonumber(coniss)
Redis:set(TheMero.."carcoronum"..Remsg.sender.user_id , carcoronoww)
coronamed = "كورولا"
Redis:set(TheMero.."carcoroname"..Remsg.sender.user_id,coronamed)
local carcoronum = Redis:get(TheMero.."carcoronum"..msg.sender.user_id) or 0
if tonumber(carcoronum) == 0 then
Redis:del(TheMero.."carcoroname"..msg.sender.user_id)
Redis:del(TheMero.."carcoronum"..msg.sender.user_id)
...
if Redis:get(TheMero.."zwag_request:"..msg.sender.user_id) then 
...
if Redis:get(TheMero.."roog1"..msg.sender.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(TheMero.."rooga1"..msg.sender.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(TheMero.."roog1"..Remsg.sender.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:get(TheMero.."rooga1"..Remsg.sender.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
...
Redis:setex(TheMero.."zwag_request:"..msg.sender.user_id,60,true)
Redis:setex(TheMero.."zwag_request:"..Remsg.sender.user_id,60,true)
...
if Redis:sismember(TheMero.."roogg1",msg.sender.user_id) or Redis:sismember(TheMero.."roogga1",msg.sender.user_id) then
local zoog = Redis:get(TheMero.."roog1"..msg.sender.user_id)
local zooga = Redis:get(TheMero.."rooga1"..msg.sender.user_id)
local mahr = Redis:get(TheMero.."rahr1"..msg.sender.user_id)
...
if Redis:sismember(TheMero.."roogg1",Remsg.sender.user_id) or Redis:sismember(TheMero.."roogga1",Remsg.sender.user_id) then
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
ballancee = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
if tonumber(ballancee) < 100 then
return send(msg.chat_id,msg.id, "⇜ فلوسك ماتكفي \n✧","md",true)
...
local zoog = Redis:get(TheMero.."roog1"..Remsg.sender.user_id)
local zooga = Redis:get(TheMero.."rooga1"..Remsg.sender.user_id)
local mahr = Redis:get(TheMero.."rahr1"..Remsg.sender.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
local convert_mony = string.format("%.0f",mahr)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(otheka))
...
local zoog = Redis:get(TheMero.."roog1"..msg.sender.user_id)
local zooga = tonumber(Redis:get(TheMero.."rooga1"..msg.sender.user_id))
...
local mahrr = Redis:get(TheMero.."rahrr1"..msg.sender.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
Redis:set(TheMero.."playerrhan"..msg.chat_id,msg.sender.user_id)
Redis:set(TheMero.."playercoins"..msg.chat_id..msg.sender.user_id,coniss)
Redis:set(TheMero.."raeahkam"..msg.chat_id,msg.sender.user_id)
Redis:sadd(TheMero..'List_rhan'..msg.chat_id,msg.sender.user_id)
...
Redis:set(TheMero.."boob"..msg.sender.user_id , rehan)
...
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
if Redis:get(TheMero.."namenade"..msg.sender.user_id) then
...
Redis:set(TheMero.."lkbnade"..msg.sender.user_id, Cnamed)
msgnade = '⇜ اختر النادي : ⚽️\n✧'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'ريال مدريد', data = msg.sender.user_id..'/realm'},{text = 'برشلونة', data = msg.sender.user_id..'/barca'},{text = 'تشيلسي', data = msg.sender.user_id..'/chels'},
},
{
{text = 'مانشستر يونايتد', data = msg.sender.user_id..'/manun'},{text = 'ليفربول', data = msg.sender.user_id..'/livb'},{text = 'انتر ميلان', data = msg.sender.user_id..'/intmi'},
},
{
{text = 'مانشستر سيتي', data = msg.sender.user_id..'/manci'},{text = 'يوفنتس', data = msg.sender.user_id..'/juvin'},{text = 'ارسنال', data = msg.sender.user_id..'/arsi'}, 
},
{
{text = 'Louis',url="t.me/Y88F8"}, 
},
...
if Redis:ttl(TheMero.."traningnade" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."traningnade" .. msg.sender.user_id))
...
namenade = Redis:get(TheMero.."namenade"..msg.sender.user_id)
energynade = Redis:get(TheMero.."energynade"..msg.sender.user_id)
lkbnade = Redis:get(TheMero.."lkbnade"..msg.sender.user_id)
namenade = Redis:get(TheMero.."namenade"..msg.sender.user_id)
energyplayer1 = Redis:get(TheMero.."energyplayer".."1"..msg.sender.user_id)
energyplayer2 = Redis:get(TheMero.."energyplayer".."2"..msg.sender.user_id)
energyplayer3 = Redis:get(TheMero.."energyplayer".."3"..msg.sender.user_id)
energyplayer4 = Redis:get(TheMero.."energyplayer".."4"..msg.sender.user_id)
energyplayer5 = Redis:get(TheMero.."energyplayer".."5"..msg.sender.user_id)
if tonumber(energynade) < 151 then
Redis:incrby(TheMero.."energynade"..msg.sender.user_id,1)
end
if energyplayer1 then
if tonumber(energyplayer1) < 151 then
Redis:incrby(TheMero.."energyplayer".."1"..msg.sender.user_id,1)
end
end
if energyplayer2 then
if tonumber(energyplayer2) < 151 then
Redis:incrby(TheMero.."energyplayer".."2"..msg.sender.user_id,1)
end
end
if energyplayer3 then
if tonumber(energyplayer3) < 151 then
Redis:incrby(TheMero.."energyplayer".."3"..msg.sender.user_id,1)
end
end
if energyplayer4 then
if tonumber(energyplayer4) < 151 then
Redis:incrby(TheMero.."energyplayer".."4"..msg.sender.user_id,1)
end
end
if energyplayer5 then
if tonumber(energyplayer5) < 151 then
Redis:incrby(TheMero.."energyplayer".."5"..msg.sender.user_id,1)
end
end
energynade = Redis:get(TheMero.."energynade"..msg.sender.user_id)
Redis:setex(TheMero.."traningnade" .. msg.sender.user_id,1800, true)
...
Redis:setex(TheMero.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(TheMero.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender.user_id) then
Redis:del(TheMero.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
Redis:srem(TheMero.."lkbnadesadd", namfra)
Redis:del(TheMero.."lkbnade"..msg.sender.user_id)
Redis:set(TheMero.."lkbnade"..msg.sender.user_id, text)
Redis:sadd(TheMero.."lkbnadesadd", text)
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
cccallcc = tonumber(ballance) - 25000
Redis:set(TheMero.."boob"..msg.sender.user_id,cccallcc)
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
...
nameplayer1 = Redis:get(TheMero.."nameplayer".."1"..msg.sender.user_id)
nameplayer2 = Redis:get(TheMero.."nameplayer".."2"..msg.sender.user_id)
nameplayer3 = Redis:get(TheMero.."nameplayer".."3"..msg.sender.user_id)
nameplayer4 = Redis:get(TheMero.."nameplayer".."4"..msg.sender.user_id)
nameplayer5 = Redis:get(TheMero.."nameplayer".."5"..msg.sender.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(TheMero.."mrkzplayer".."1"..msg.sender.user_id)
cityplayer1 = Redis:get(TheMero.."cityplayer".."1"..msg.sender.user_id)
energyplayer1 = Redis:get(TheMero.."energyplayer".."1"..msg.sender.user_id)
priceplayer1 = Redis:get(TheMero.."priceplayer".."1"..msg.sender.user_id)
nameplayer1done = "⌯ اسم اللاعب : `"..nameplayer1.."`\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n- السعر : "..priceplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(TheMero.."mrkzplayer".."2"..msg.sender.user_id)
cityplayer2 = Redis:get(TheMero.."cityplayer".."2"..msg.sender.user_id)
energyplayer2 = Redis:get(TheMero.."energyplayer".."2"..msg.sender.user_id)
priceplayer2 = Redis:get(TheMero.."priceplayer".."2"..msg.sender.user_id)
nameplayer2done = "⌯ اسم اللاعب : `"..nameplayer2.."`\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n- السعر : "..priceplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(TheMero.."mrkzplayer".."3"..msg.sender.user_id)
cityplayer3 = Redis:get(TheMero.."cityplayer".."3"..msg.sender.user_id)
energyplayer3 = Redis:get(TheMero.."energyplayer".."3"..msg.sender.user_id)
priceplayer3 = Redis:get(TheMero.."priceplayer".."3"..msg.sender.user_id)
nameplayer3done = "⌯ اسم اللاعب : `"..nameplayer3.."`\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n- السعر : "..priceplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(TheMero.."mrkzplayer".."4"..msg.sender.user_id)
cityplayer4 = Redis:get(TheMero.."cityplayer".."4"..msg.sender.user_id)
energyplayer4 = Redis:get(TheMero.."energyplayer".."4"..msg.sender.user_id)
priceplayer4 = Redis:get(TheMero.."priceplayer".."4"..msg.sender.user_id)
nameplayer4done = "⌯ اسم اللاعب : `"..nameplayer4.."`\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n- السعر : "..priceplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(TheMero.."mrkzplayer".."5"..msg.sender.user_id)
cityplayer5 = Redis:get(TheMero.."cityplayer".."5"..msg.sender.user_id)
energyplayer5 = Redis:get(TheMero.."energyplayer".."5"..msg.sender.user_id)
priceplayer5 = Redis:get(TheMero.."priceplayer".."5"..msg.sender.user_id)
...
Redis:setex(TheMero.."shoplyname" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(TheMero.."shoplyname" .. msg.chat_id .. ":" .. msg.sender.user_id) then
Redis:del(TheMero.."shoplyname" .. msg.chat_id .. ":" .. msg.sender.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
...
Redis:set(TheMero.."boob"..msg.sender.user_id,pricetotaly)
Redis:del(TheMero.."nameplayer".."1"..msg.sender.user_id)
Redis:del(TheMero.."energyplayer".."1"..msg.sender.user_id)
Redis:del(TheMero.."mrkzplayer".."1"..msg.sender.user_id)
Redis:del(TheMero.."cityplayer".."1"..msg.sender.user_id)
...
energynade = Redis:get(TheMero.."energynade"..msg.sender.user_id)
lkbnade = Redis:get(TheMero.."lkbnade"..msg.sender.user_id)
nokatnade = Redis:get(TheMero.."nokatnade"..msg.sender.user_id) or 0
nameplayer1 = Redis:get(TheMero.."nameplayer".."1"..msg.sender.user_id)
nameplayer2 = Redis:get(TheMero.."nameplayer".."2"..msg.sender.user_id)
nameplayer3 = Redis:get(TheMero.."nameplayer".."3"..msg.sender.user_id)
nameplayer4 = Redis:get(TheMero.."nameplayer".."4"..msg.sender.user_id)
...
if not Redis:get(TheMero.."namenade" .. Remsg.sender.user_id) then
...
namenade = Redis:get(TheMero.."namenade"..Remsg.sender.user_id)
energynade = Redis:get(TheMero.."energynade"..Remsg.sender.user_id)
lkbnade = Redis:get(TheMero.."lkbnade"..Remsg.sender.user_id)
nokatnade = Redis:get(TheMero.."nokatnade"..Remsg.sender.user_id) or 0
nameplayer1 = Redis:get(TheMero.."nameplayer".."1"..Remsg.sender.user_id)
nameplayer2 = Redis:get(TheMero.."nameplayer".."2"..Remsg.sender.user_id)
nameplayer3 = Redis:get(TheMero.."nameplayer".."3"..Remsg.sender.user_id)
nameplayer4 = Redis:get(TheMero.."nameplayer".."4"..Remsg.sender.user_id)
nameplayer5 = Redis:get(TheMero.."nameplayer".."5"..Remsg.sender.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(TheMero.."mrkzplayer".."1"..Remsg.sender.user_id)
cityplayer1 = Redis:get(TheMero.."cityplayer".."1"..Remsg.sender.user_id)
energyplayer1 = Redis:get(TheMero.."energyplayer".."1"..Remsg.sender.user_id)
nameplayer1done = "⌯ اسم اللاعب : "..nameplayer1.."\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(TheMero.."mrkzplayer".."2"..Remsg.sender.user_id)
cityplayer2 = Redis:get(TheMero.."cityplayer".."2"..Remsg.sender.user_id)
energyplayer2 = Redis:get(TheMero.."energyplayer".."2"..Remsg.sender.user_id)
nameplayer2done = "⌯ اسم اللاعب : "..nameplayer2.."\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(TheMero.."mrkzplayer".."3"..Remsg.sender.user_id)
cityplayer3 = Redis:get(TheMero.."cityplayer".."3"..Remsg.sender.user_id)
energyplayer3 = Redis:get(TheMero.."energyplayer".."3"..Remsg.sender.user_id)
nameplayer3done = "⌯ اسم اللاعب : "..nameplayer3.."\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(TheMero.."mrkzplayer".."4"..Remsg.sender.user_id)
cityplayer4 = Redis:get(TheMero.."cityplayer".."4"..Remsg.sender.user_id)
energyplayer4 = Redis:get(TheMero.."energyplayer".."4"..Remsg.sender.user_id)
nameplayer4done = "⌯ اسم اللاعب : "..nameplayer4.."\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(TheMero.."mrkzplayer".."5"..Remsg.sender.user_id)
cityplayer5 = Redis:get(TheMero.."cityplayer".."5"..Remsg.sender.user_id)
energyplayer5 = Redis:get(TheMero.."energyplayer".."5"..Remsg.sender.user_id)
nameplayer5done = "⌯ اسم اللاعب : "..nameplayer5.."\n- مركزه : "..mrkzplayer5.."\n- طاقة اللاعب : "..energyplayer5.."\n- الجنسية : "..cityplayer5.."\n\n"
else
nameplayer5done = ""
end
...
if Redis:ttl(TheMero.."matchode" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."matchode" .. msg.sender.user_id))
...
namenade = Redis:get(TheMero.."namenade"..msg.sender.user_id)
energynade = Redis:get(TheMero.."energynade"..msg.sender.user_id)
energyplayer1 = Redis:get(TheMero.."energyplayer".."1"..msg.sender.user_id) or 0
energyplayer2 = Redis:get(TheMero.."energyplayer".."2"..msg.sender.user_id) or 0
energyplayer3 = Redis:get(TheMero.."energyplayer".."3"..msg.sender.user_id) or 0
energyplayer4 = Redis:get(TheMero.."energyplayer".."4"..msg.sender.user_id) or 0
energyplayer5 = Redis:get(TheMero.."energyplayer".."5"..msg.sender.user_id) or 0
...
Redis:set(TheMero.."boob"..msg.sender.user_id,cccallcc)
Redis:incrby(TheMero.."energynade"..msg.sender.user_id,1)
Redis:incrby(TheMero.."nokatnade"..msg.sender.user_id,1)
Redis:setex(TheMero.."matchode" .. msg.sender.user_id,1200, true)
send(msg.chat_id,msg.id, "⌯ لقد فزت بالمبارة "..news.." ⚽️\n⇜ اسم النادي : "..namenade.."\n⇜ نادي الخصم : "..nadebot.."\n⇜ النتيجة : "..result.."\n⇜ تم زيادة نقطة لطاقة ناديك\n✧","md",true)
elseif energymynade < tonumber(energybot) then
Redis:decrby(TheMero.."energynade"..msg.sender.user_id,1)
energynade = Redis:get(TheMero.."energynade"..msg.sender.user_id)
if tonumber(energynade) < 0 then
Redis:set(TheMero.."energynade"..msg.sender.user_id,0)
end
Redis:decrby(TheMero.."nokatnade"..msg.sender.user_id,1)
nokatnade = Redis:get(TheMero.."nokatnade"..msg.sender.user_id)
if tonumber(nokatnade) < 0 then
Redis:set(TheMero.."nokatnade"..msg.sender.user_id,0)
end
Redis:setex(TheMero.."matchode" .. msg.sender.user_id,1200, true)
...
if Redis:ttl(TheMero.."matchplayer" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."matchplayer" .. msg.sender.user_id))
...
namenadevs = Redis:get(TheMero.."namenade"..Remsg.sender.user_id)
energynadevs = Redis:get(TheMero.."energynade"..Remsg.sender.user_id)
energyplayer1vs = Redis:get(TheMero.."energyplayer".."1"..Remsg.sender.user_id) or 0
energyplayer2vs = Redis:get(TheMero.."energyplayer".."2"..Remsg.sender.user_id) or 0
energyplayer3vs = Redis:get(TheMero.."energyplayer".."3"..Remsg.sender.user_id) or 0
energyplayer4vs = Redis:get(TheMero.."energyplayer".."4"..Remsg.sender.user_id) or 0
energyplayer5vs = Redis:get(TheMero.."energyplayer".."5"..Remsg.sender.user_id) or 0
...
Redis:decrby(TheMero.."energynade"..Remsg.sender.user_id,1)
energynadevs = Redis:get(TheMero.."energynade"..Remsg.sender.user_id)
if tonumber(energynadevs) < 0 then
Redis:set(TheMero.."energynade"..Remsg.sender.user_id,0)
end
if energyplayer1vs then
Redis:decrby(TheMero.."energyplayer".."1"..Remsg.sender.user_id,1)
end
energyplayer1vs = Redis:get(TheMero.."energyplayer".."1"..Remsg.sender.user_id)
if tonumber(energyplayer1vs) < 0 then
Redis:set(TheMero.."energyplayer".."1"..Remsg.sender.user_id,0)
end
if energyplayer2vs then
Redis:decrby(TheMero.."energyplayer".."2"..Remsg.sender.user_id,1)
end
energyplayer2vs = Redis:get(TheMero.."energyplayer".."2"..Remsg.sender.user_id)
if tonumber(energyplayer2vs) < 0 then
Redis:set(TheMero.."energyplayer".."2"..Remsg.sender.user_id,0)
end
if energyplayer3vs then
Redis:decrby(TheMero.."energyplayer".."3"..Remsg.sender.user_id,1)
end
energyplayer3vs = Redis:get(TheMero.."energyplayer".."3"..Remsg.sender.user_id)
if tonumber(energyplayer3vs) < 0 then
Redis:set(TheMero.."energyplayer".."3"..Remsg.sender.user_id,0)
end
if energyplayer4vs then
Redis:decrby(TheMero.."energyplayer".."4"..Remsg.sender.user_id,1)
end
energyplayer4vs = Redis:get(TheMero.."energyplayer".."4"..Remsg.sender.user_id)
if tonumber(energyplayer4vs) < 0 then
Redis:set(TheMero.."energyplayer".."4"..Remsg.sender.user_id,0)
end
if energyplayer5vs then
Redis:decrby(TheMero.."energyplayer".."5"..Remsg.sender.user_id,1)
end
energyplayer5vs = Redis:get(TheMero.."energyplayer".."5"..Remsg.sender.user_id)
if tonumber(energyplayer5vs) < 0 then
Redis:set(TheMero.."energyplayer".."5"..Remsg.sender.user_id,0)
end
Redis:decrby(TheMero.."nokatnade"..Remsg.sender.user_id,1)
nokatnadevs = Redis:get(TheMero.."nokatnade"..Remsg.sender.user_id)
if tonumber(nokatnadevs) < 0 then
Redis:set(TheMero.."nokatnade"..Remsg.sender.user_id,0)
end
Redis:setex(TheMero.."matchplayer" .. msg.sender.user_id,1200, true)
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
...
Redis:incrby(TheMero.."energynade"..Remsg.sender.user_id,1)
Redis:incrby(TheMero.."nokatnade"..Remsg.sender.user_id,1)
if energyplayer1vs then
Redis:incrby(TheMero.."energyplayer".."1"..Remsg.sender.user_id,1)
end
if energyplayer2vs then
Redis:incrby(TheMero.."energyplayer".."2"..Remsg.sender.user_id,1)
end
if energyplayer3vs then
Redis:incrby(TheMero.."energyplayer".."3"..Remsg.sender.user_id,1)
end
if energyplayer4vs then
Redis:incrby(TheMero.."energyplayer".."4"..Remsg.sender.user_id,1)
end
if energyplayer5vs then
Redis:incrby(TheMero.."energyplayer".."5"..Remsg.sender.user_id,1)
end
Redis:decrby(TheMero.."energynade"..msg.sender.user_id,1)
energynade = Redis:get(TheMero.."energynade"..msg.sender.user_id)
if tonumber(energynade) < 0 then
...
if energyplayer1 then
Redis:decrby(TheMero.."energyplayer".."1"..msg.sender.user_id,1)
end
energyplayer1 = Redis:get(TheMero.."energyplayer".."1"..msg.sender.user_id)
if tonumber(energyplayer1) < 0 then
Redis:set(TheMero.."energyplayer".."1"..msg.sender.user_id,0)
end
if energyplayer2 then
Redis:decrby(TheMero.."energyplayer".."2"..msg.sender.user_id,1)
end
energyplayer2 = Redis:get(TheMero.."energyplayer".."2"..msg.sender.user_id)
if tonumber(energyplayer2) < 0 then
Redis:set(TheMero.."energyplayer".."2"..msg.sender.user_id,0)
end
if energyplayer3 then
Redis:decrby(TheMero.."energyplayer".."3"..msg.sender.user_id,1)
end
energyplayer3 = Redis:get(TheMero.."energyplayer".."3"..msg.sender.user_id)
if tonumber(energyplayer3) < 0 then
Redis:set(TheMero.."energyplayer".."3"..msg.sender.user_id,0)
end
if energyplayer4 then
Redis:decrby(TheMero.."energyplayer".."4"..msg.sender.user_id,1)
end
energyplayer4 = Redis:get(TheMero.."energyplayer".."4"..msg.sender.user_id)
if tonumber(energyplayer4) < 0 then
Redis:set(TheMero.."energyplayer".."4"..msg.sender.user_id,0)
end
if energyplayer5 then
Redis:decrby(TheMero.."energyplayer".."5"..msg.sender.user_id,1)
end
energyplayer5 = Redis:get(TheMero.."energyplayer".."5"..msg.sender.user_id)
if tonumber(energyplayer5) < 0 then
Redis:set(TheMero.."energyplayer".."5"..msg.sender.user_id,0)
end
Redis:decrby(TheMero.."nokatnade"..msg.sender.user_id,1)
nokatnade = Redis:get(TheMero.."nokatnade"..msg.sender.user_id)
if tonumber(nokatnade) < 0 then
...
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
if Redis:get(TheMero.."mrkzplayer".."1"..msg.sender.user_id) and Redis:get(TheMero.."mrkzplayer".."2"..msg.sender.user_id) and Redis:get(TheMero.."mrkzplayer".."3"..msg.sender.user_id) and Redis:get(TheMero.."mrkzplayer".."4"..msg.sender.user_id) and Redis:get(TheMero.."mrkzplayer".."5"..msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ النادي الخاص بك مكتمل\n⇜ تستطيع بيع لاعب عن طريق الامر ( بيع لاعب )  ","md",true)
end
if Redis:ttl(TheMero.."buyplayer" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."buyplayer" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"⇜ تستطيع شراء لاعب بعد "..time.." ","md",true)
end
Redis:setex(TheMero.."buyplayer" .. msg.sender.user_id,900, true)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/luisyes'},{text = 'لا', data = msg.sender.user_id..'/luisno'},
},
}
}
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/danyes'},{text = 'لا', data = msg.sender.user_id..'/danno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/fdnyes'},{text = 'لا', data = msg.sender.user_id..'/fdnno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/rafyes'},{text = 'لا', data = msg.sender.user_id..'/rafno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/kuanyes'},{text = 'لا', data = msg.sender.user_id..'/kuanno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/hariyes'},{text = 'لا', data = msg.sender.user_id..'/harino'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/romoyes'},{text = 'لا', data = msg.sender.user_id..'/romono'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/tiagoyes'},{text = 'لا', data = msg.sender.user_id..'/tiagono'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/gerardyes'},{text = 'لا', data = msg.sender.user_id..'/gerardno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/tyryes'},{text = 'لا', data = msg.sender.user_id..'/tyrno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/osmanyes'},{text = 'لا', data = msg.sender.user_id..'/osmanno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/rodrigoyes'},{text = 'لا', data = msg.sender.user_id..'/rodrigono'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/milyes'},{text = 'لا', data = msg.sender.user_id..'/milno'},
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/albayes'},{text = 'لا', data = msg.sender.user_id..'/albano'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/fenesyes'},{text = 'لا', data = msg.sender.user_id..'/fenesno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/demayes'},{text = 'لا', data = msg.sender.user_id..'/demano'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/danilyes'},{text = 'لا', data = msg.sender.user_id..'/danilno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/daneleyes'},{text = 'لا', data = msg.sender.user_id..'/daneleno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/ibrahyes'},{text = 'لا', data = msg.sender.user_id..'/ibrahno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/donaryes'},{text = 'لا', data = msg.sender.user_id..'/donarno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/ashrfyes'},{text = 'لا', data = msg.sender.user_id..'/ashrfno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/idenyes'},{text = 'لا', data = msg.sender.user_id..'/idenno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/sergyes'},{text = 'لا', data = msg.sender.user_id..'/sergno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/fermyes'},{text = 'لا', data = msg.sender.user_id..'/fermno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/jackyes'},{text = 'لا', data = msg.sender.user_id..'/jackno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/ansloyes'},{text = 'لا', data = msg.sender.user_id..'/anslono'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/toresyes'},{text = 'لا', data = msg.sender.user_id..'/toresno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/muleryes'},{text = 'لا', data = msg.sender.user_id..'/mulerno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/brunoyes'},{text = 'لا', data = msg.sender.user_id..'/brunono'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/paulyes'},{text = 'لا', data = msg.sender.user_id..'/paulno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/modricyes'},{text = 'لا', data = msg.sender.user_id..'/modricno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/iscoyes'},{text = 'لا', data = msg.sender.user_id..'/iscnono'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/fabinyes'},{text = 'لا', data = msg.sender.user_id..'/fabinno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/hinsonyes'},{text = 'لا', data = msg.sender.user_id..'/hinsonno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/janyes'},{text = 'لا', data = msg.sender.user_id..'/janno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/kayloryes'},{text = 'لا', data = msg.sender.user_id..'/kaylorno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/sommeryes'},{text = 'لا', data = msg.sender.user_id..'/sommerno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/brendyes'},{text = 'لا', data = msg.sender.user_id..'/brendyes'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/mendyyes'},{text = 'لا', data = msg.sender.user_id..'/mendyno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/onanayes'},{text = 'لا', data = msg.sender.user_id..'/onanano'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/royyes'},{text = 'لا', data = msg.sender.user_id..'/royno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/kasperyes'},{text = 'لا', data = msg.sender.user_id..'/kasperno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/geayes'},{text = 'لا', data = msg.sender.user_id..'/geano'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/felixyes'},{text = 'لا', data = msg.sender.user_id..'/felixno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/salahyes'},{text = 'لا', data = msg.sender.user_id..'/salahno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/neymaryes'},{text = 'لا', data = msg.sender.user_id..'/neymarno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/sadioyes'},{text = 'لا', data = msg.sender.user_id..'/sadiono'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/rehimyes'},{text = 'لا', data = msg.sender.user_id..'/rehimno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/sanchoyes'},{text = 'لا', data = msg.sender.user_id..'/sanchono'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
data = {
{
{text = 'نعم', data = msg.sender.user_id..'/sonyes'},{text = 'لا', data = msg.sender.user_id..'/sonno'},
},
}
}
send(msg.chat_id,msg.id,msgplayer,"md",false, false, false, false, reply_markup)
...
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
ballanceed = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
namefram = Redis:get(TheMero.."namefram"..msg.sender.user_id)
if Redis:get(TheMero.."sizefram"..msg.sender.user_id) then
...
Redis:set(TheMero.."namefram"..msg.sender.user_id, Cnamed)
ttshakse = '⇜ اختر مساحة المزرعة : 🛣\n✧'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '4×4', data = msg.sender.user_id..'/4×4'},{text = '6×6', data = msg.sender.user_id..'/6×6'},{text = '8×8', data = msg.sender.user_id..'/8×8'},
},
{
{text = '12×12', data = msg.sender.user_id..'/12×12'},{text = '16×16', data = msg.sender.user_id..'/16×16'},{text = '32×32', data = msg.sender.user_id..'/32×32'},
},
{
{text = 'Louis',url="t.me/Y88F8"}, 
},
...
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
if not Redis:get(TheMero.."sizefram" .. msg.sender.user_id) then
...
local namefram = Redis:get(TheMero.."namefram"..msg.sender.user_id)
local sizefram = Redis:get(TheMero.."sizefram"..msg.sender.user_id)
local mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
local mazofxbh = tonumber(sizefram) - tonumber(mzroatsize)
local btatahours = Redis:ttl(TheMero.."btatatime" .. msg.sender.user_id) / 60
local btatatime = Redis:get(TheMero.."btatatime" .. msg.sender.user_id)
local btataname = Redis:get(TheMero.."btataname"..msg.sender.user_id)
local btatanum = Redis:get(TheMero.."btatanum"..msg.sender.user_id) or 0
...
local lemonhours = Redis:ttl(TheMero.."lemontime" .. msg.sender.user_id) / 60
local lemontime = Redis:get(TheMero.."lemontime" .. msg.sender.user_id)
local lemonname = Redis:get(TheMero.."lemonname"..msg.sender.user_id)
local lemonnum = Redis:get(TheMero.."lemonnum"..msg.sender.user_id) or 0
...
local khesshours = Redis:ttl(TheMero.."khesstime" .. msg.sender.user_id) / 60
local khesstime = Redis:get(TheMero.."khesstime" .. msg.sender.user_id)
local khessname = Redis:get(TheMero.."khessname"..msg.sender.user_id)
local khessnum = Redis:get(TheMero.."khessnum"..msg.sender.user_id) or 0
...
local khearhours = Redis:ttl(TheMero.."kheartime" .. msg.sender.user_id) / 60
local kheartime = Redis:get(TheMero.."kheartime" .. msg.sender.user_id)
local khearname = Redis:get(TheMero.."khearname"..msg.sender.user_id)
local khearnum = Redis:get(TheMero.."khearnum"..msg.sender.user_id) or 0
...
local jzarhours = Redis:ttl(TheMero.."jzartime" .. msg.sender.user_id) / 60
local jzartime = Redis:get(TheMero.."jzartime" .. msg.sender.user_id)
local jzarname = Redis:get(TheMero.."jzarname"..msg.sender.user_id)
local jzarnum = Redis:get(TheMero.."jzarnum"..msg.sender.user_id) or 0
...
local fleflahours = Redis:ttl(TheMero.."fleflatime" .. msg.sender.user_id) / 60
local fleflatime = Redis:get(TheMero.."fleflatime" .. msg.sender.user_id)
local fleflaname = Redis:get(TheMero.."fleflaname"..msg.sender.user_id)
local fleflanum = Redis:get(TheMero.."fleflanum"..msg.sender.user_id) or 0
...
local freazhours = Redis:ttl(TheMero.."freaztime" .. msg.sender.user_id) / 60
local freaztime = Redis:get(TheMero.."freaztime" .. msg.sender.user_id)
local freazname = Redis:get(TheMero.."freazname"..msg.sender.user_id)
local freaznum = Redis:get(TheMero.."freaznum"..msg.sender.user_id) or 0
...
local dorahours = Redis:ttl(TheMero.."doratime" .. msg.sender.user_id) / 60
local doratime = Redis:get(TheMero.."doratime" .. msg.sender.user_id)
local doraname = Redis:get(TheMero.."doraname"..msg.sender.user_id)
local doranum = Redis:get(TheMero.."doranum"..msg.sender.user_id) or 0
...
local tomhours = Redis:ttl(TheMero.."tomtime" .. msg.sender.user_id) / 60
local tomtime = Redis:get(TheMero.."tomtime" .. msg.sender.user_id)
local tomname = Redis:get(TheMero.."tomname"..msg.sender.user_id)
local tomnum = Redis:get(TheMero.."tomnum"..msg.sender.user_id) or 0
...
local ftrhours = Redis:ttl(TheMero.."ftrtime" .. msg.sender.user_id) / 60
local ftrtime = Redis:get(TheMero.."ftrtime" .. msg.sender.user_id)
local ftrname = Redis:get(TheMero.."ftrname"..msg.sender.user_id)
local ftrnum = Redis:get(TheMero.."ftrnum"..msg.sender.user_id) or 0
...
local tfahhours = Redis:ttl(TheMero.."tfahtime" .. msg.sender.user_id) / 60
local tfahtime = Redis:get(TheMero.."tfahtime" .. msg.sender.user_id)
local tfahname = Redis:get(TheMero.."tfahname"..msg.sender.user_id)
local tfahnum = Redis:get(TheMero.."tfahnum"..msg.sender.user_id) or 0
...
local enabhours = Redis:ttl(TheMero.."enabtime" .. msg.sender.user_id) / 60
local enabtime = Redis:get(TheMero.."enabtime" .. msg.sender.user_id)
local enabname = Redis:get(TheMero.."enabname"..msg.sender.user_id)
local enabnum = Redis:get(TheMero.."enabnum"..msg.sender.user_id) or 0
...
local zetonhours = Redis:ttl(TheMero.."zetontime" .. msg.sender.user_id) / 60
local zetontime = Redis:get(TheMero.."zetontime" .. msg.sender.user_id)
local zetonname = Redis:get(TheMero.."zetonname"..msg.sender.user_id)
local zetonnum = Redis:get(TheMero.."zetonnum"..msg.sender.user_id) or 0
...
local mozzhours = Redis:ttl(TheMero.."mozztime" .. msg.sender.user_id) / 60
local mozztime = Redis:get(TheMero.."mozztime" .. msg.sender.user_id)
local mozzname = Redis:get(TheMero.."mozzname"..msg.sender.user_id)
local mozznum = Redis:get(TheMero.."mozznum"..msg.sender.user_id) or 0
...
local mangahours = Redis:ttl(TheMero.."mangatime" .. msg.sender.user_id) / 60
local mangatime = Redis:get(TheMero.."mangatime" .. msg.sender.user_id)
local manganame = Redis:get(TheMero.."manganame"..msg.sender.user_id)
local manganum = Redis:get(TheMero.."manganum"..msg.sender.user_id) or 0
...
if Redis:get(TheMero.."btatatime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."btatatime" .. msg.sender.user_id) / 60
...
if Redis:get(TheMero.."btatanum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بطاطا قبل 🥔\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد بطاطا`","md",true)
end
kajwha = tonumber(coniss) * 0.7
sizefram = Redis:get(TheMero.."sizefram"..msg.sender.user_id)
if tonumber(kajwha) > tonumber(sizefram) then
return send(msg.chat_id,msg.id, "⇜ مايمديك تشتري مساحة ارضك ماتكفي","md",true)
end
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
...
Redis:set(TheMero.."btatanum"..msg.sender.user_id , coniss)
btataname = "بطاطا"
Redis:set(TheMero.."btataname"..msg.sender.user_id , btataname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
btatasize = tonumber(coniss) * 0.7
btatasizee = btatasize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(btatasizee))
totalypalice = tonumber(ballance) - tonumber(btata)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."btatatime"..msg.sender.user_id,1220, true)
local convert_mony = string.format("%.0f",math.floor(btata))
toplvfarm = Redis:get(TheMero.."toplvfarm"..msg.sender.user_id) or 0
toplvfarmm = tonumber(toplvfarm) + tonumber(coniss)
Redis:set(TheMero.."toplvfarm"..msg.sender.user_id , toplvfarmm)
...
if Redis:get(TheMero.."lemontime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."lemontime" .. msg.sender.user_id) / 60
...
if Redis:get(TheMero.."lemonnum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بندوره قبل 🍅\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد بندوره`","md",true)
end
...
Redis:set(TheMero.."lemonnum"..msg.sender.user_id , coniss)
lemonname = "بندوره"
Redis:set(TheMero.."lemonname"..msg.sender.user_id , lemonname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
lemonsize = tonumber(coniss) * 1
lemonsizee = lemonsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(lemonsizee))
totalypalice = tonumber(ballance) - tonumber(lemon)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."lemontime"..msg.sender.user_id,1520, true)
...
if Redis:get(TheMero.."khesstime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."khesstime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
if Redis:get(TheMero.."khessnum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
...
Redis:set(TheMero.."khessnum"..msg.sender.user_id , coniss)
khessname = "خس"
Redis:set(TheMero.."khessname"..msg.sender.user_id , khessname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
khesssize = tonumber(coniss) * 1.2
khesssizee = khesssize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(khesssizee))
totalypalice = tonumber(ballance) - tonumber(khess)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."khesstime"..msg.sender.user_id,1800, true)
...
if Redis:get(TheMero.."kheartime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."kheartime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
if Redis:get(TheMero.."khearnum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
...
Redis:set(TheMero.."khearnum"..msg.sender.user_id , coniss)
khearname = "خيار"
Redis:set(TheMero.."khearname"..msg.sender.user_id , khearname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
khearsize = tonumber(coniss) * 1.5
khearsizee = khearsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(khearsizee))
totalypalice = tonumber(ballance) - tonumber(khear)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."kheartime"..msg.sender.user_id,2120, true)
...
if Redis:get(TheMero.."jzartime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."jzartime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
if Redis:get(TheMero.."jzarnum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
...
Redis:set(TheMero.."jzarnum"..msg.sender.user_id , coniss)
jzarname = "جزر"
Redis:set(TheMero.."jzarname"..msg.sender.user_id , jzarname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
jzarsize = tonumber(coniss) * 1.7
jzarsizee = jzarsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(jzarsizee))
totalypalice = tonumber(ballance) - tonumber(jzar)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."jzartime"..msg.sender.user_id,2420, true)
...
if Redis:get(TheMero.."fleflatime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."fleflatime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
if Redis:get(TheMero.."fleflanum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
...
Redis:set(TheMero.."fleflanum"..msg.sender.user_id , coniss)
fleflaname = "فليفله"
Redis:set(TheMero.."fleflaname"..msg.sender.user_id , fleflaname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
fleflasize = tonumber(coniss) * 2
fleflasizee = fleflasize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(fleflasizee))
totalypalice = tonumber(ballance) - tonumber(flefla)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."fleflatime"..msg.sender.user_id,2720, true)
...
if Redis:get(TheMero.."freaztime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."freaztime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
if Redis:get(TheMero.."freaznum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
...
Redis:set(TheMero.."freaznum"..msg.sender.user_id , coniss)
freazname = "فريز"
Redis:set(TheMero.."freazname"..msg.sender.user_id , freazname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
freazsize = tonumber(coniss) * 3
freazsizee = freazsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(freazsizee))
totalypalice = tonumber(ballance) - tonumber(freaz)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."freaztime"..msg.sender.user_id,3020, true)
...
if Redis:get(TheMero.."doratime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."doratime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
if Redis:get(TheMero.."doranum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
...
Redis:set(TheMero.."doranum"..msg.sender.user_id , coniss)
doraname = "ذره"
Redis:set(TheMero.."doraname"..msg.sender.user_id , doraname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
dorasize = tonumber(coniss) * 4
dorasizee = dorasize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(dorasizee))
totalypalice = tonumber(ballance) - tonumber(dora)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."doratime"..msg.sender.user_id,3320, true)
...
if Redis:get(TheMero.."tomtime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."tomtime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
if Redis:get(TheMero.."tomnum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
...
Redis:set(TheMero.."tomnum"..msg.sender.user_id , coniss)
tomname = "ثوم"
Redis:set(TheMero.."tomname"..msg.sender.user_id , tomname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
tomsize = tonumber(coniss) * 5
tomsizee = tomsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(tomsizee))
totalypalice = tonumber(ballance) - tonumber(tom)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."tomtime"..msg.sender.user_id,3620, true)
...
if Redis:get(TheMero.."ftrtime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."ftrtime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
if Redis:get(TheMero.."ftrnum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
...
Redis:set(TheMero.."ftrnum"..msg.sender.user_id , coniss)
ftrname = "فطر"
Redis:set(TheMero.."ftrname"..msg.sender.user_id , ftrname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
ftrsize = tonumber(coniss) * 6
ftrsizee = ftrsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(ftrsizee))
totalypalice = tonumber(ballance) - tonumber(ftr)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."ftrtime"..msg.sender.user_id,4220, true)
...
if Redis:get(TheMero.."tfahtime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."tfahtime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
if Redis:get(TheMero.."tfahnum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
...
Redis:set(TheMero.."tfahnum"..msg.sender.user_id , coniss)
tfahname = "تفاح"
Redis:set(TheMero.."tfahname"..msg.sender.user_id , tfahname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
tfahsize = tonumber(coniss) * 10
tfahsizee = tfahsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(tfahsizee))
totalypalice = tonumber(ballance) - tonumber(tfah)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."tfahtime"..msg.sender.user_id,5420, true)
...
if Redis:get(TheMero.."enabtime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."enabtime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
if Redis:get(TheMero.."enabnum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
...
Redis:set(TheMero.."enabnum"..msg.sender.user_id , coniss)
enabname = "عنب"
Redis:set(TheMero.."enabname"..msg.sender.user_id , enabname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
enabsize = tonumber(coniss) * 12.5
enabsizee = enabsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(enabsizee))
totalypalice = tonumber(ballance) - tonumber(enab)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."enabtime"..msg.sender.user_id,6020, true)
...
if Redis:get(TheMero.."zetontime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."zetontime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
if Redis:get(TheMero.."zetonnum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
...
Redis:set(TheMero.."zetonnum"..msg.sender.user_id , coniss)
zetonname = "زيتون"
Redis:set(TheMero.."zetonname"..msg.sender.user_id , zetonname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
zetonsize = tonumber(coniss) * 15
zetonsizee = zetonsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(zetonsizee))
totalypalice = tonumber(ballance) - tonumber(zeton)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."zetontime"..msg.sender.user_id,7220, true)
...
if Redis:get(TheMero.."mozztime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."mozztime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
if Redis:get(TheMero.."mozznum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
...
Redis:set(TheMero.."mozznum"..msg.sender.user_id , coniss)
mozzname = "موز"
Redis:set(TheMero.."mozzname"..msg.sender.user_id , mozzname)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
mozzsize = tonumber(coniss) * 20
mozzsizee = mozzsize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(mozzsizee))
totalypalice = tonumber(ballance) - tonumber(mozz)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."mozztime"..msg.sender.user_id,8420, true)
...
if Redis:get(TheMero.."mangatime" .. msg.sender.user_id) then
local hours = Redis:ttl(TheMero.."mangatime" .. msg.sender.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
if Redis:get(TheMero.."manganum" .. msg.sender.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
...
Redis:set(TheMero.."manganum"..msg.sender.user_id , coniss)
manganame = "مانجا"
Redis:set(TheMero.."manganame"..msg.sender.user_id , manganame)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender.user_id) or 0
mangasize = tonumber(coniss) * 30
mangasizee = mangasize + mzroatsize
Redis:set(TheMero.."mzroatsize"..msg.sender.user_id , math.floor(mangasizee))
totalypalice = tonumber(ballance) - tonumber(manga)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(totalypalice))
Redis:setex(TheMero.."mangatime"..msg.sender.user_id,10220, true)
...
if not Redis:get(TheMero.."btatanum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
btatanum = Redis:get(TheMero.."btatanum"..msg.sender.user_id)
btata = tonumber(btatanum) * 100
btataa = tonumber(ballance) + tonumber(btata)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(btataa))
local convert_mony = string.format("%.0f",math.floor(btata))
...
if not Redis:get(TheMero.."lemonnum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
lemonnum = Redis:get(TheMero.."lemonnum"..msg.sender.user_id)
lemon = tonumber(lemonnum) * 150
lemona = tonumber(ballance) + tonumber(lemon)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(lemona))
local convert_mony = string.format("%.0f",math.floor(lemon))
...
if not Redis:get(TheMero.."khessnum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
khessnum = Redis:get(TheMero.."khessnum"..msg.sender.user_id)
khess = tonumber(khessnum) * 200
khessa = tonumber(ballance) + tonumber(khess)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(khessa))
local convert_mony = string.format("%.0f",math.floor(khess))
...
if not Redis:get(TheMero.."khearnum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
khearnum = Redis:get(TheMero.."khearnum"..msg.sender.user_id)
khear = tonumber(khearnum) * 250
kheara = tonumber(ballance) + tonumber(khear)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(kheara))
local convert_mony = string.format("%.0f",math.floor(khear))
...
if not Redis:get(TheMero.."jzarnum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
jzarnum = Redis:get(TheMero.."jzarnum"..msg.sender.user_id)
jzar = tonumber(jzarnum) * 300
jzara = tonumber(ballance) + tonumber(jzar)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(jzara))
local convert_mony = string.format("%.0f",math.floor(jzar))
...
if not Redis:get(TheMero.."fleflanum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
fleflanum = Redis:get(TheMero.."fleflanum"..msg.sender.user_id)
flefla = tonumber(fleflanum) * 350
fleflaa = tonumber(ballance) + tonumber(flefla)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(fleflaa))
local convert_mony = string.format("%.0f",math.floor(flefla))
...
if not Redis:get(TheMero.."freaznum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
freaznum = Redis:get(TheMero.."freaznum"..msg.sender.user_id)
freaz = tonumber(freaznum) * 475
freaza = tonumber(ballance) + tonumber(freaz)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(freaza))
local convert_mony = string.format("%.0f",math.floor(freaz))
...
if not Redis:get(TheMero.."doranum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
doranum = Redis:get(TheMero.."doranum"..msg.sender.user_id)
dora = tonumber(doranum) * 600
doraa = tonumber(ballance) + tonumber(dora)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(doraa))
local convert_mony = string.format("%.0f",math.floor(dora))
...
if not Redis:get(TheMero.."tomnum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
tomnum = Redis:get(TheMero.."tomnum"..msg.sender.user_id)
tom = tonumber(tomnum) * 725
toma = tonumber(ballance) + tonumber(tom)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(toma))
local convert_mony = string.format("%.0f",math.floor(tom))
...
if not Redis:get(TheMero.."ftrnum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
ftrnum = Redis:get(TheMero.."ftrnum"..msg.sender.user_id)
ftr = tonumber(ftrnum) * 800
ftra = tonumber(ballance) + tonumber(ftr)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(ftra))
local convert_mony = string.format("%.0f",math.floor(ftr))
...
if not Redis:get(TheMero.."tfahnum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
tfahnum = Redis:get(TheMero.."tfahnum"..msg.sender.user_id)
tfah = tonumber(tfahnum) * 1200
tfaha = tonumber(ballance) + tonumber(tfah)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(tfaha))
local convert_mony = string.format("%.0f",math.floor(tfah))
...
if not Redis:get(TheMero.."enabnum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
enabnum = Redis:get(TheMero.."enabnum"..msg.sender.user_id)
enab = tonumber(enabnum) * 1500
enaba = tonumber(ballance) + tonumber(enab)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(enaba))
local convert_mony = string.format("%.0f",math.floor(enab))
...
if not Redis:get(TheMero.."zetonnum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
zetonnum = Redis:get(TheMero.."zetonnum"..msg.sender.user_id)
zeton = tonumber(zetonnum) * 1800
zetona = tonumber(ballance) + tonumber(zeton)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(zetona))
local convert_mony = string.format("%.0f",math.floor(zeton))
...
if not Redis:get(TheMero.."mozznum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
mozznum = Redis:get(TheMero.."mozznum"..msg.sender.user_id)
mozz = tonumber(mozznum) * 2500
mozza = tonumber(ballance) + tonumber(mozz)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(mozza))
local convert_mony = string.format("%.0f",math.floor(mozz))
...
if not Redis:get(TheMero.."manganum"..msg.sender.user_id) then
...
ballance = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
manganum = Redis:get(TheMero.."manganum"..msg.sender.user_id)
manga = tonumber(manganum) * 3500
mangaa = tonumber(ballance) + tonumber(manga)
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(mangaa))
local convert_mony = string.format("%.0f",math.floor(manga))
...
if Redis:ttl(TheMero.."yiioooo" .. msg.sender.user_id) >=60 then
local hours = Redis:ttl(TheMero.."yiioooo" .. msg.sender.user_id) / 60
...
Redis:set(TheMero.."boob"..msg.sender.user_id , knez)
local ballancee = Redis:get(TheMero.."boob"..msg.sender.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id,""..neews.." لقد وجدت كنز\n⇜ الكنز : قطعة اثرية 🗳\n⇜ سعره : 40000 درهم 💵\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
Redis:setex(TheMero.."yiioooo" .. msg.sender.user_id,1800, true)
elseif Descriptioont == "2" then
...
Redis:set(TheMero.."boob"..Remsg.sender.user_id , bajiop)
ccccc = Redis:get(TheMero.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(TheMero.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(TheMero.."rrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender.user_id) or 0
...
Redis:set(TheMero.."tdbelballance"..msg.sender.user_id , coniss)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text == 'تبرع' then
if Redis:ttl(TheMero.."tabrotime" .. msg.sender.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."tabrotime" .. msg.sender.user_id))
...
Redis:set(TheMero.."boob"..msg.sender.user_id , math.floor(byre))
taeswq = Redis:get(TheMero.."tabbroat"..msg.sender.user_id) or 0
pokloo = tonumber(taeswq) + tonumber(coniss)
Redis:set(TheMero.."tabbroat"..msg.sender.user_id , math.floor(pokloo))
...
ballanceeed = Redis:get(TheMero.."boob"..winner_id) or 0
Redis:sadd(TheMero.."taza",msg.sender.user_id)
Redis:setex(TheMero.."tabrotime" .. msg.sender.user_id,600, true)
...
if Redis:sismember(TheMero.."booob",msg.sender.user_id) then
ballancee = Redis:get(TheMero.."tabbroat"..msg.sender.user_id) or 0
if tonumber(ballancee) < 1 then
