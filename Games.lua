...
Redis:incrby(TheMero.."Mero:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMero.."Mero:Game:Smile"..msg.chat_id)
local Num = Redis:get(TheMero.."Mero:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
...
if Redis:get(TheMero.."Mero:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return send(msg_chat_id,msg_id,"⇜ مايمديك تخمن عدد اكبر من ( 20 ) خمن رقم ما بين ( 1 - 20 )\n","md",true)
end 
local GETNUM = Redis:get(TheMero.."Mero:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheMero.."Mero:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMero.."Mero:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheMero.."Mero:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return send(msg_chat_id,msg_id,"⇜ مبروك فزت وخمنت الرقم الصحيح\n⇜ تم اضافة لك ( 5 ) نقاط \n✧","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheMero.."Mero:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheMero.."Mero:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheMero.."Mero:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMero.."Mero:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheMero.."gamebot:Set:Manager:rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."gamebot:Set:Manager:rd"..msg.sender.user_id..":"..msg.chat_id,"true1uu")
Redis:sadd(TheMero.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم حفظ السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:Set:Manager:rdd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."gamebot:Set:Manager:rdd"..msg.sender.user_id..":"..msg.chat_id,"true1uu")
Redis:srem(TheMero.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم مسح السؤال')
end
end
if Redis:get(TheMero.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'start' then
if msg.content.audio then  
Redis:set(TheMero.."audio:Games"..msg.sender.user_id..":"..msg.chat_id,msg.content.audio.audio.remote.id)  
Redis:sadd(TheMero.."audio:Games:Bot",msg.content.audio.audio.remote.id)  
Redis:set(TheMero.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id,'started')
return send(msg.chat_id, msg.id,'⇜ ارسل الجواب الان ...')
end   
end
if Redis:get(TheMero.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'started' then
local Id_audio = Redis:get(TheMero.."audio:Games"..msg.sender.user_id..":"..msg.chat_id)
Redis:set(TheMero..'Text:Games:audio'..Id_audio,text)
Redis:del(TheMero.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id)
...
if Redis:get(TheMero.."mero:All:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(TheMero.."mero:All:text:Games:Bot",text) then
send(msg_chat_id,msg_id,'⇜ لا يوجد صوت بهذا الاسم عام')
Redis:del(TheMero.."mero:All:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id)
return false
end
...
if Redis:get(TheMero.."mero:All:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'start' then
Redis:set(TheMero..'mero:All:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(TheMero.."mero:All:text:Games:Bot",text)  
Redis:set(TheMero.."mero:All:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفظه باسم : '..text)
return false
end
if Redis:get(TheMero.."mero:All:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
...
if Redis:get(TheMero.."mero:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'startdel' then
...
Redis:del(TheMero.."mero:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id)
return false
end
...
if Redis:get(TheMero.."mero:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'start' then
Redis:set(TheMero..'mero:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(TheMero.."mero:text:Games:Bot"..msg.chat_id,text)  
Redis:set(TheMero.."mero:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفضه باسم : '..text)
return false
end
if Redis:get(TheMero.."mero:Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"truefguigf1")
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true1")
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as1"..quschen,text)
Redis:set(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true2")
return send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as2"..quschen,text)
Redis:set(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true3")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as3"..quschen,text)
Redis:set(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true4")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الرابع') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true4" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as0"..quschen,text)
Redis:set(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true44")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الاجوبة \n⇜ ارسل الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as4"..quschen,text)
Redis:set(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true186")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "truedel" then
send(msg_chat_id,msg_id, '\n⇜ تم مسح الغز ')
Redis:set(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"truefguigf1")
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ اللغز \n⇜ ارسل الجواب الاول')
Redis:set(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true1")
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني')
local quschen = Redis:get(TheMero.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."lkz:gamebot:newqus:as1"..quschen,text)
Redis:set(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true2")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true2" then
send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث')
local quschen = Redis:get(TheMero.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."lkz:gamebot:newqus:as2"..quschen,text)
Redis:set(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true3")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true3" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الصحيح')
local quschen = Redis:get(TheMero.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."lkz:gamebot:newqus:as3"..quschen,text)
Redis:set(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true44")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true44" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح')
local quschen = Redis:get(TheMero.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."lkz:gamebot:newqus:as4"..quschen,text)
Redis:set(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true186")
return false 
end
end
if Redis:get(TheMero..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(TheMero..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(TheMero..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبة الغباء : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(TheMero..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبة الذكاء : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(TheMero..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبه الكره : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(TheMero..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⇜ نسبة الرجوله : '..text..' '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(TheMero..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⇜ نسبه الانوثة : '..text..' '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end
...
if text == "انا" then
if Redis:sismember(TheMero..'List_Ahkamm'..msg.chat_id,msg.sender.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(TheMero..'members_Ahkamm'..msg.chat_id,msg.sender.user_id)
Redis:sadd(TheMero..'List_Ahkamm'..msg.chat_id,msg.sender.user_id)
...
if Redis:sismember(TheMero..'List_Ahkkam'..msg.chat_id,msg.sender.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(TheMero..'List_Ahkkam'..msg.chat_id,msg.sender.user_id)
...
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender.user_id..')'
...
if Redis:sismember(TheMero..'List_Koorsi'..msg.chat_id,msg.sender.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(TheMero..'List_Koorsi'..msg.chat_id,msg.sender.user_id)
...
if Redis:sismember(TheMero..'List_rhan'..msg.chat_id,msg.sender.user_id) then
...
if RtList == "3" then
Redis:incrby(TheMero.."Mero:Num:Add:Games"..msg.chat_id..msg.sender.user_id,3)
StatusRt = "الف مبروك حظك حلو ربحت 3 نقاط"
elseif RtList == "5" then
Redis:incrby(TheMero.."Mero:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)
StatusRt = "الف مبروك حظك حلو ربحت 5 نقاط"
elseif RtList == "-3" then
Redis:decrby(TheMero.."Mero:Num:Add:Games"..msg.chat_id..msg.sender.user_id,3)  
StatusRt = "للاسف حظك زفت خسرت 3 نقاط"
elseif RtList == "-5" then
Redis:decrby(TheMero.."Mero:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
...
Redis:set(TheMero.."gamebot:Set:Manager:rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheMero.."gamebot:Set:Manager:rdd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheMero.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
Redis:set(TheMero.."raeahkamm"..msg.chat_id,msg.sender.user_id)
Redis:sadd(TheMero..'List_Ahkamm'..msg.chat_id,msg.sender.user_id)
Redis:sadd(TheMero..'members_Ahkamm'..msg.chat_id,msg.sender.user_id)
...
Redis:set(TheMero.."raeahkkam"..msg.chat_id,msg.sender.user_id)
Redis:sadd(TheMero..'List_Ahkkam'..msg.chat_id,msg.sender.user_id)
...
Redis:set(TheMero.."raekoorsi"..msg.chat_id,msg.sender.user_id)
Redis:sadd(TheMero..'List_Koorsi'..msg.chat_id,msg.sender.user_id)
...
Redis:set(TheMero.."raesaraha"..msg.chat_id,msg.sender.user_id)
Redis:sadd(TheMero..'List_Saraha'..msg.chat_id,msg.sender.user_id)
...
Redis:set(TheMero.."Ak_Tmooh"..msg.chat_id,Message_Reply.sender.user_id)
Redis:del(TheMero..'List_Aktooh'..msg.chat_id)
Redis:set(TheMero.."raeaktooh"..msg.chat_id,msg.sender.user_id)
Redis:sadd(TheMero..'List_Aktooh'..msg.chat_id,msg.sender.user_id)
...
Redis:set(TheMero.."makal:bots:set"..msg.sender.user_id..":"..msg.chat_id,true)
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
Redis:set(TheMero.."makal:bots:del"..msg.sender.user_id..":"..msg.chat_id,true)
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."makal:bots:del"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."makal:bots:del"..msg.sender.user_id..":"..msg.chat_id,"true1uu")
Redis:srem(TheMero.."makal:bots", text)
return send(msg_chat_id,msg_id, '\n⇜ تم مسح السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."makal:bots:set"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."makal:bots:set"..msg.sender.user_id..":"..msg.chat_id,"true1uu")
...
Redis:setex(TheMero.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender.user_id, 60, true) 
end
end
end
if text == ""..(Redis:get(TheMero.."makal:bots:qus"..msg.chat_id) or '').."" then
local timemkall = Redis:ttl(TheMero.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
Redis:del(TheMero.."makal:bots:qus"..msg.sender.user_id..":"..msg.chat_id)
Redis:del(TheMero.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender.user_id) 
end
if text =="صراحه" then
if Redis:get(TheMero.."Mero:Status:Games:malk"..msg.chat_id) then
return false 
...
Redis:set(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheMero.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل اللغز الان ")
end
...
Redis:set(TheMero..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '⇜ الان ارسل اسمك واسم الشخص الثاني '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:tahaath"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:tahaath"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:klp"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:donke"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:donke"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:klp"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:zahf"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:zahf"..msg.chat_id, Message_Reply.sender.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته حمار 🦓\n✧️")
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:sakl"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:sakl"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:klpe"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:klpe"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:tagge"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:tagge"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:mrtee"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:mrtee"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:loke"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:loke"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(TheMero.."mero:stope"..msg.chat_id, Message_Reply.sender.user_id)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(TheMero.."mero:stope"..msg.chat_id, Message_Reply.sender.user_id)
...
if tonumber(member_id) == tonumber(msg.sender.user_id) or tonumber(member_id) == tonumber(TheMero) or bot.getUser(member_id).type.luatele == "userTypeBot" or Redis:get(TheMero..msg_chat_id..member_id.."mtzwga:") then 
return send(msg_chat_id,msg_id,"⇜ اسف ياحلو مو وقت زواج الحين","md")
end
if Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwg_id =  Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:")
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(TheMero..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(TheMero) then
  return send(msg_chat_id,msg_id,"⇜ هييه مايمديك تتزوجني\n✧","md")
elseif Redis:get(TheMero..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:") then
local zwg_id =  Redis:get(TheMero..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
local zwg_info = bot.getUser(zwg_id)
return send(msg_chat_id,msg_id,"⇜ وينك ياوحش\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\n⇜ يبون يتزوجو زوجتك ","md")
elseif Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:")
  local zwg_info = bot.getUser(zwg_id)
  return send(msg_chat_id,msg_id,"⇜ الحين اناديها انتظر\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\n⇜ يبي يتزوج عليك هههه","md")
elseif not Redis:get(TheMero..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")  then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local rep_info = bot.getUser(Message_Reply.sender.user_id)
local rep_tag = "["..rep_info.first_name.."](tg://user?id="..Message_Reply.sender.user_id..")"
local user_info = bot.getUser(msg.sender.user_id)
...
if text == "زوجتي" then
  if Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwga_id = Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:")
  ...
  elseif not Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:") then
...
elseif tonumber(Redis:get(TheMero..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) ~= tonumber(msg.sender.user_id) or tonumber(Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender.user_id) then
  return send(msg_chat_id,msg_id,"⇜ هييه مايمديك تطلقها لان مو زوجتك\n✧","md")
elseif tonumber(Redis:get(TheMero..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
    Redis:del(TheMero..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
    Redis:del(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:")
...
if text == "طلقني" or text == "طلقيني" then
  if not Redis:get(TheMero..msg_chat_id..msg.sender.user_id.."mtzwga:") then 
...
keyboard = {}
keyboard.inline_keyboard = {{{text = '• اغنية اخرى •', callback_data = msg.sender.user_id..'/kanele'}}}
local msg_id = msg.id/2097152/0.5
...
Redis:set(TheMero.."Mero:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
if Redis:get(TheMero.."Mero:Status:Games"..msg.chat_id) then
Redis:del(TheMero..":Number_Add:"..msg.chat_id..msg.sender.user_id) 
Redis:del(TheMero..':List_Rolet:'..msg.chat_id)  
Redis:setex(TheMero..":Start_Rolet:"..msg.chat_id..msg.sender.user_id,3600,true)  
return send(msg_chat_id,msg_id, '⇜ حسناً لنلعب , ارسل عدد اللاعبين للروليت .',"md")
end
end
if text == 'نعم' and Redis:get(TheMero..":Witting_StartGame:"..msg.chat_id..msg.sender.user_id) then
...
Redis:incrby(TheMero.."Mero:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 5)  
Redis:del(TheMero..':List_Rolet:'..msg.chat_id) 
Redis:del(TheMero..":Witting_StartGame:"..msg.chat_id..msg.sender.user_id)
...
if text and text:match("^(%d+)$") and Redis:get(TheMero..":Start_Rolet:"..msg.chat_id..msg.sender.user_id) then
if text == "1" then
Text = "⇜ لا استطيع بدء اللعبة بلاعب واحد فقط\n"
else
Redis:set(TheMero..":Number_Add:"..msg.chat_id..msg.sender.user_id,text)  
Text = '⇜ يرجى ارسال يوزرات اللاعبين \n⇜ الفائز يحصل على ( 5 ) نقاط\n⇜ عدد الاعبين المطلوبين ( '..text..' ) لاعب \n ✧'
end
Redis:del(TheMero..":Start_Rolet:"..msg.chat_id..msg.sender.user_id)  
return send(msg_chat_id,msg_id,Text)    
end
if text and text:match('^(@[%a%d_]+)$') and Redis:get(TheMero..":Number_Add:"..msg.chat_id..msg.sender.user_id) then    --// استقبال الاسماء
...
local CountAdd = Redis:get(TheMero..":Number_Add:"..msg.chat_id..msg.sender.user_id)
local CountAll = Redis:scard(TheMero..':List_Rolet:'..msg.chat_id)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
Redis:del(TheMero..":Number_Add:"..msg.chat_id..msg.sender.user_id) 
Redis:setex(TheMero..":Witting_StartGame:"..msg.chat_id..msg.sender.user_id,1400,true)  
