...
local Teext = '⇜ من ['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')\n'
...
if tonumber(msg.sender.user_id) == tonumber(TheMero) then
print('This is reply for Bot')
return false
end
if msg.sender.luatele == "messageSenderChat" then
if Redis:sismember(TheMero.."Mero:SilentGroup:Group"..msg_chat_id,msg.sender.chat_id) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if Redis:get(TheMero.."Mero:Lock:SenderChat"..msg_chat_id) then
local m = Redis:get(TheMero.."chadmin"..msg_chat_id) 
if msg.sender.chat_id == tonumber(m) then
return false
else
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
if tonumber(msg.sender.user_id) == 779108237 then
msg.Name_Controller = '𝗠𝗬𝗧𝗛️'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2089102006 then
msg.Name_Controller = 'Master🎖️'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'Dev🎖️'
elseif Redis:sismember(TheMero.."Mero:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Myth🎖️️'
elseif Redis:sismember(TheMero.."Mero:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheMero..'Mero:SetRt'..msg.chat_id..':'..msg.sender.user_id) or Redis:get(TheMero.."Mero:Developer:Bot:Reply"..msg.chat_id) or 'Myth'
elseif Redis:sismember(TheMero.."Mero:MalekAsase:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 444
msg.Name_Controller = Redis:get(TheMero..'Mero:SetRt'..msg.chat_id..':'..msg.sender.user_id) or Redis:get(TheMero.."Mero:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheMero.."Mero:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheMero..'Mero:SetRt'..msg.chat_id..':'..msg.sender.user_id) or Redis:get(TheMero.."Mero:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheMero.."Mero:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheMero..'Mero:SetRt'..msg.chat_id..':'..msg.sender.user_id) or Redis:get(TheMero.."Mero:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheMero.."Mero:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheMero..'Mero:SetRt'..msg.chat_id..':'..msg.sender.user_id) or Redis:get(TheMero.."Mero:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ'
elseif Redis:sismember(TheMero.."Mero:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheMero..'Mero:SetRt'..msg.chat_id..':'..msg.sender.user_id) or Redis:get(TheMero.."Mero:Manager:Group:Reply"..msg.chat_id) or 'المدير'
elseif Redis:sismember(TheMero.."Mero:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheMero..'Mero:SetRt'..msg.chat_id..':'..msg.sender.user_id) or Redis:get(TheMero.."Mero:Admin:Group:Reply"..msg.chat_id) or 'الادمن'
elseif Redis:sismember(TheMero.."Mero:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheMero..'Mero:SetRt'..msg.chat_id..':'..msg.sender.user_id) or Redis:get(TheMero.."Mero:Vip:Group:Reply"..msg.chat_id) or 'مميز'
elseif tonumber(msg.sender.user_id) == tonumber(TheMero) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheMero..'Mero:SetRt'..msg.chat_id..':'..msg.sender.user_id) or Redis:get(TheMero.."Mero:Mempar:Group:Reply"..msg.chat_id) or 'عضو'
end  
...
if Message_Edit.sender.user_id == TheMero then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
if tonumber(Message_Edit.sender.user_id) == 779108237 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender.user_id) == 2089102006 then
data.The_Controller = 1
elseif The_ControllerAll(Message_Edit.sender.user_id) == true then  
data.The_Controller = 1
elseif Redis:sismember(TheMero.."Mero:DevelopersQ:Groups",Message_Edit.sender.user_id) == true then
data.The_Controller = 2
elseif Redis:sismember(TheMero.."Mero:Developers:Groups",Message_Edit.sender.user_id) == true then
data.The_Controller = 3
elseif Redis:sismember(TheMero.."Mero:TheBasicsQ:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 44
elseif Redis:sismember(TheMero.."Mero:TheBasics:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 4
elseif Redis:sismember(TheMero.."Mero:Originators:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 5
elseif Redis:sismember(TheMero.."Mero:Managers:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 6
elseif Redis:sismember(TheMero.."Mero:Addictive:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 7
elseif Redis:sismember(TheMero.."Mero:Distinguished:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 8
elseif tonumber(Message_Edit.sender.user_id) == tonumber(TheMero) then
...
local UserInfo = bot.getUser(Message_Edit.sender.user_id)
local names = FlterBio(UserInfo.first_name) 
local monsha = Redis:smembers(TheMero.."Mero:TheBasicsQ:Group"..data.chat_id) 
Redis:incr(TheMero..'Mero:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
...
local UserInfo = bot.getUser(Message_Edit.sender.user_id)
local Teext = '「 ['..UserInfo.first_name..'](tg://user?id='..Message_Edit.sender.user_id..') 」\n'
return send(data.chat_id,0,Teext..'⇜ ممنوع التعديل \n ✧',"md")
end
end
end
end
if not data.Originators and Message_Edit.sender.user_id ~= tonumber(TheMero) then
...
local tecxt = ListMembers.."\n\n".."\n⇜ المستخدم ["..names.." ](tg://user?id="..Message_Edit.sender.user_id..")"..
"\n⇜ قام بتعديل الميديا"
